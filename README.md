...
Reachability analysis is used to verify whether the goal property can be reached within the number of steps. The goal property can be defined using the same predicates described in the [Queries](./README.md#queries) section above
