...
(and (= (obligation3 -1) true)
 (= obligation3U_-1 queryVARuser1 ) (= obligation3ar_-1 queryVARar ) (= obligation3T_-1 queryVARo )))

;POST PROPERTY
(declare-fun queryVARuser2 () Int)
(assert 
(and (= (obligation5 0) true)
 (= obligation5U_0 queryVARuser2 ) (= obligation5ar_0 queryVARar ) (= obligation5T_0 queryVARo )))
(check-sat)
