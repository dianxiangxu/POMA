...
(declare-fun ?ancestor1_customvar_1 () Int)

(declare-fun ?ancestor2_customvar_1 () Int)

(declare-fun ?bm_customvar_1 () Int)

(declare-fun ?ancestor3_customvar_1 () Int)

(declare-fun ?dean_customvar_1 () Int)

(declare-fun ?ancestor4_customvar_1 () Int)
...
(assert 
(and (= (add_copi 0) true)
 (= add_copiU_0 queryVARu1 ) (= add_copiar_0 queryVARar1 ) (= add_copiT_0 queryVARat1 )))
(check-sat)
(get-value (add_copi))
