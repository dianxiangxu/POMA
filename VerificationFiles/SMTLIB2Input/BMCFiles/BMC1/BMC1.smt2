...
(assert (=> (=(obligation1 0) true) (= (ASSIGN 1) (ASSIGN 0))))
(assert (=> (= (obligation1 0) true)(= (ASSOC 1) (setminus(union(union(ASSOC 0)(singleton(mkTuple 2 30 15)))(singleton(mkTuple 2 26 15)))(singleton(mkTuple 14 27 15))))))
...
(declare-fun queryVARPERMITUA_PI_submit_PDSWhole_0 () Int)
(declare-fun queryVARPERMITAT_PI_submit_PDSWhole_0 () Int)
(assert (and (and 
(and (= (obligation1 0) true)
 (= obligation1S_0 14 ) (= obligation1ar_0 27 ) (= obligation1T_0 15 )) 
(and(member (mkTuple  14  queryVARPERMITUA_PI_submit_PDSWhole_0 ) (ASSIGN* 0))(member (mkTuple  queryVARPERMITUA_PI_submit_PDSWhole_0 27  queryVARPERMITAT_PI_submit_PDSWhole_0 ) (ASSOC 0))(member (mkTuple  15  queryVARPERMITAT_PI_submit_PDSWhole_0 ) (ASSIGN* 0)))
) 
(member (mkTuple  14  27  15 ) (ASSOC 0))
))
(check-sat)
