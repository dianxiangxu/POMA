...
(assert (=> (=(obligation1 6) true) (= (ASSIGN 7) (ASSIGN 6))))
(assert (=> (= (obligation1 6) true)(= (ASSOC 7) (setminus(union(ASSOC 6)(singleton(mkTuple 2 47 27)))(singleton(mkTuple 26 47 27))))))
...
(assert (=> (=(obligation2 6) true) (= (ASSIGN 7) (ASSIGN 6))))
(assert (=> (= (obligation2 6) true)(= (ASSOC 7) (setminus(setminus(union(union(ASSOC 6)(singleton(mkTuple 6 47 27)))(singleton(mkTuple 6 43 27)))(singleton(mkTuple 2 47 27)))(singleton(mkTuple 2 43 27))))))




(assert (=> (= (obligation3 6) true)(= (ASSIGN* 7)(union (singleton (mkTuple 7 15)) (union (join (singleton (mkTuple 7 15)) (join (singleton (mkTuple 15 15)) (ASSIGN* 6))) (ASSIGN* 6))))))
(assert (=> (= (obligation3 6) true)(= (ASSIGN 7)( union (ASSIGN 6) (singleton (mkTuple 7 15))))))
(assert (=> (= (obligation3 6) true)(= (ASSOC 7) (setminus(union(ASSOC 6)(singleton(mkTuple 21 47 27)))(singleton(mkTuple 6 47 27))))))




(assert (=> (= (obligation4 6) true)(= (ASSIGN* 7) (setminus (ASSIGN* 6) (setminus (join (singleton (mkTuple 7 15)) (ASSIGN* 6)) (join (join (singleton (mkTuple 7 7)) (setminus (setminus (ASSIGN 6) (singleton (mkTuple 7 15))) (singleton (mkTuple 7 7)))) (ASSIGN* 6)))))))
(assert (=> (= (obligation4 6) true)(= (ASSIGN 7) (setminus (ASSIGN 6) (singleton (mkTuple 7 15))))))
