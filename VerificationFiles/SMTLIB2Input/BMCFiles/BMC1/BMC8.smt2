...
(assert (= obligation1ar_8 15))
(assert (=> (= (obligation1 7) true) (let((.def_U obligation1U_8)(.def_UO obligation1UO_8) (.def_UA obligation1UA_8)(.def_AT obligation1AT_8))(and
 (member (mkTuple  8 .def_UA) (ASSIGN* 7))
(member (mkTuple .def_UA obligation1ar_8 .def_AT) (ASSOC 7))
 (member (mkTuple  1 .def_AT) (ASSIGN* 7))
))))
...
(assert (= obligation2ar_8 15))
(assert (=> (= (obligation2 7) true) (let((.def_U obligation2U_8)(.def_UO obligation2UO_8) (.def_UA obligation2UA_8)(.def_AT obligation2AT_8))(and
 (member (mkTuple  4 .def_UA) (ASSIGN* 7))
(member (mkTuple .def_UA obligation2ar_8 .def_AT) (ASSOC 7))
 (member (mkTuple  1 .def_AT) (ASSIGN* 7))
))))
...
(assert (= obligation3ar_8 15))
(assert (=> (= (obligation3 7) true) (let((.def_U obligation3U_8)(.def_UO obligation3UO_8) (.def_UA obligation3UA_8)(.def_AT obligation3AT_8))(and
 (member (mkTuple  6 .def_UA) (ASSIGN* 7))
(member (mkTuple .def_UA obligation3ar_8 .def_AT) (ASSOC 7))
 (member (mkTuple  1 .def_AT) (ASSIGN* 7))
))))
...
(assert (= obligation4ar_8 15))
(assert (=> (= (obligation4 7) true) (let((.def_U obligation4U_8)(.def_UO obligation4UO_8) (.def_UA obligation4UA_8)(.def_AT obligation4AT_8))(and
 (member (mkTuple  2 .def_UA) (ASSIGN* 7))
(member (mkTuple .def_UA obligation4ar_8 .def_AT) (ASSOC 7))
 (member (mkTuple  1 .def_AT) (ASSIGN* 7))
))))
...
(assert (= obligation5ar_8 15))
(assert (=> (= (obligation5 7) true) (let((.def_U obligation5U_8)(.def_UO obligation5UO_8) (.def_UA obligation5UA_8)(.def_AT obligation5AT_8))(and
 (member (mkTuple  8 .def_UA) (ASSIGN* 7))
(member (mkTuple .def_UA obligation5ar_8 .def_AT) (ASSOC 7))
 (member (mkTuple  1 .def_AT) (ASSIGN* 7))
))))
...
(assert (=> (= (obligation1 7) true)(subset (ASSIGN* 8) (union (singleton (mkTuple 4 8)) (union (join (singleton (mkTuple 4 8)) (join (singleton (mkTuple 8 8)) (ASSIGN* 7))) (ASSIGN* 7))))))
(assert (=> (= (obligation1 7) true)(subset (ASSIGN 8)( union (ASSIGN 7) (singleton (mkTuple 4 8))))))(assert (=> (=(obligation1 7) true) (= (ASSOC 8) (ASSOC 7))))


(assert (=> (= (obligation2 7) true)(subset (ASSIGN* 8) (union (join (join (union (singleton (mkTuple 6 6)) (join (ASSIGN* 7) (singleton (mkTuple 6 6)))) (singleton (mkTuple 6 4))) (union (singleton (mkTuple 4 4)) (join (singleton (mkTuple 4 4)) (ASSIGN* 7) ))) (ASSIGN* 7)))))
(assert (=> (= (obligation2 7) true)(subset (ASSIGN 8)( union (ASSIGN 7) (singleton (mkTuple 6 4))))))(assert (=> (=(obligation2 7) true) (= (ASSOC 8) (ASSOC 7))))


(assert (=> (= (obligation3 7) true)(subset (ASSIGN* 8) (union (join (join (union (singleton (mkTuple 2 2)) (join (ASSIGN* 7) (singleton (mkTuple 2 2)))) (singleton (mkTuple 2 6))) (union (singleton (mkTuple 6 6)) (join (singleton (mkTuple 6 6)) (ASSIGN* 7) ))) (ASSIGN* 7)))))
(assert (=> (= (obligation3 7) true)(subset (ASSIGN 8)( union (ASSIGN 7) (singleton (mkTuple 2 6))))))(assert (=> (=(obligation3 7) true) (= (ASSOC 8) (ASSOC 7))))


(assert (=> (= (obligation4 7) true)(subset (ASSOC 8) (union  (ASSOC 7) (singleton(mkTuple 7 16 9))))))


(assert (=> (= (obligation5 7) true)(subset (ASSIGN* 8) (setminus (ASSIGN* 7) (setminus (setminus (union (singleton (mkTuple 6 8)) (join (singleton (mkTuple 6 8)) (ASSIGN* 7))) (join (join (intersection (join (union  (singleton (mkTuple 6 6)) (join (ASSIGN* 7)  (singleton (mkTuple 6 6)))) (transpose (union  (singleton (mkTuple 6 6)) (join (ASSIGN* 7)  (singleton (mkTuple 6 6)))))) NODES) (setminus (ASSIGN 7) (singleton (mkTuple 6 8)))) (ASSIGN* 7))) (join (join (intersection (join (union  (singleton (mkTuple 6 6)) (join (ASSIGN* 7)  (singleton (mkTuple 6 6)))) (transpose (union  (singleton (mkTuple 6 6)) (join (ASSIGN* 7)  (singleton (mkTuple 6 6)))))) NODES) (setminus (ASSIGN 7) (singleton (mkTuple 6 8)))) (ASSIGN* 7)))))))
(assert (=> (= (obligation5 7) true)(subset (ASSIGN* 8) (setminus (ASSIGN 7) (singleton (mkTuple 6 8))))))
...
;QUERY
(declare-fun query1U7 () Int)(declare-fun query1UO7 () Int)(declare-fun query1UA7 () Int)(declare-fun query1AT7 () Int)(declare-fun query1ar7 () Int)(assert (= query1ar7 null))
(assert (not (let( (.def_U query1U7)(.def_UA query1UA7) (.def_UO query1UO7) (.def_AT query1AT7) (.def_AT query1AT7))(and(member (mkTuple  .def_U .def_UA) (ASSIGN* 8))(member (mkTuple .def_UA query1ar7 .def_AT) (ASSOC 8))(member (mkTuple  9 .def_AT) (ASSIGN* 8))))))
