...
;QUERY
(declare-fun query1U5 () Int)(declare-fun query1UO5 () Int)(declare-fun query1UA5 () Int)(declare-fun query1AT5 () Int)(declare-fun query1ar5 () Int)(assert (= query1ar5 null))
(assert (not (let( (.def_U query1U5)(.def_UA query1UA5) (.def_UO query1UO5) (.def_AT query1AT5) (.def_AT query1AT5))(and(member (mkTuple  .def_U .def_UA) (ASSIGN* 6))(member (mkTuple .def_UA query1ar5 .def_AT) (ASSOC 6))(member (mkTuple  9 .def_AT) (ASSIGN* 6))))))
