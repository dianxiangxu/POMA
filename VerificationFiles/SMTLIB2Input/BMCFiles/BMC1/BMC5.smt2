...
(and (member (mkTuple 7 18 3) (ASSOC* 4))   (= (accept_refuse_case_A 4) 1))
)
)				
(assert 
(xor 
(= (withdraw_case_info 4) 0) 
(and (member (mkTuple 10 15 3) (ASSOC* 4))   (= (withdraw_case_info 4) 1))
)
)				
(assert 
(xor 
(= (accept_case_Final 4) 0) 
(and (member (mkTuple 7 18 3) (ASSOC* 4))   (= (accept_case_Final 4) 1))
)
)				
(assert 
(xor 
(= (approve_case 4) 0) 
(and (member (mkTuple 2 20 3) (ASSOC* 4))   (= (approve_case 4) 1))
)
)				
...
(xor (= (ASSOC 5) 
(setminus (union  (ASSOC 4) (singleton(mkTuple 6 18 3))) (singleton(mkTuple 7 20 13))))
(= (ASSOC 5) (ASSOC 4))))

(and  (= (withdraw_case_info 4) 1)
(xor (= (ASSOC 5) 
(union (union  (ASSOC 4) (singleton(mkTuple 7 18 13))) (singleton(mkTuple 7 19 13))))
(= (ASSOC 5) (ASSOC 4))))

(and  (= (accept_case_Final 4) 1)
(xor (= (ASSOC 5) 
(union  (ASSOC 4) (singleton(mkTuple 2 20 13))))
(= (ASSOC 5) (ASSOC 4))))

(and  (= (approve_case 4) 1)
(xor (= (ASSOC 5) 
(setminus  (ASSOC 4) (singleton(mkTuple 2 20 13))))
(= (ASSOC 5) (ASSOC 4))))
...
;QUERY
(assert (= (approve_case 4) 1))


;QUERY
(assert (not (member (mkTuple 2 20 3) (ASSOC* 4))))
