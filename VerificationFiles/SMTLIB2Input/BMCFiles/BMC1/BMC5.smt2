...
;QUERY
(declare-fun query1U4 () Int)(declare-fun query1UO4 () Int)(declare-fun query1UA4 () Int)(declare-fun query1AT4 () Int)(declare-fun query1ar4 () Int)(assert (= query1ar4 null))
(assert (not (let( (.def_U query1U4)(.def_UA query1UA4) (.def_UO query1UO4) (.def_AT query1AT4) (.def_AT query1AT4))(and(member (mkTuple  .def_U .def_UA) (ASSIGN* 5))(member (mkTuple .def_UA query1ar4 .def_AT) (ASSOC 5))(member (mkTuple  9 .def_AT) (ASSIGN* 5))))))
