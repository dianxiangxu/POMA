...
(assert (=> (= (obligation6 3) 1) (let((.def_U obligation6U_4)(.def_UO obligation6UO_4) (.def_UA obligation6UA_4)(.def_AT obligation6AT_4))(and
...
(assert (=> (= (obligation7 3) 1) (let((.def_U obligation7U_4)(.def_UO obligation7UO_4) (.def_UA obligation7UA_4)(.def_AT obligation7AT_4))(and
...
(assert (=> (= (obligation8 3) 1) (let((.def_U obligation8U_4)(.def_UO obligation8UO_4) (.def_UA obligation8UA_4)(.def_AT obligation8AT_4))(and
...
(assert (=> (= (obligation9 3) 1) (let((.def_U obligation9U_4)(.def_UO obligation9UO_4) (.def_UA obligation9UA_4)(.def_AT obligation9AT_4))(and
...
(assert (=> (= (obligation10 3) 1) (let((.def_U obligation10U_4)(.def_UO obligation10UO_4) (.def_UA obligation10UA_4)(.def_AT obligation10AT_4))(and
...
(assert (=> (= (obligation11 3) 1) (let((.def_U obligation11U_4)(.def_UO obligation11UO_4) (.def_UA obligation11UA_4)(.def_AT obligation11AT_4))(and
...
(assert (=> (= (obligation12 3) 1) (let((.def_U obligation12U_4)(.def_UO obligation12UO_4) (.def_UA obligation12UA_4)(.def_AT obligation12AT_4))(and
 (member (mkTuple  5 .def_UA) (ASSIGN* 3))
...
(assert (=> (= (obligation13 3) 1) (let((.def_U obligation13U_4)(.def_UO obligation13UO_4) (.def_UA obligation13UA_4)(.def_AT obligation13AT_4))(and
 (member (mkTuple  4 .def_UA) (ASSIGN* 3))
...
; 5.2 a->Eff
(assert (=> (= (obligation1 3) 1)(= (ASSOC 4)(union  (ASSOC 3) (singleton(mkTuple 2 39 16))))))(assert (=> (= (obligation1 3) 1)(= (ASSOC 4)(setminus  (ASSOC 3) (singleton(mkTuple 15 39 16))))))
(assert (=> (= (obligation2 3) 1)(= (ASSOC 4)(union  (ASSOC 3) (singleton(mkTuple 7 39 16))))))(assert (=> (= (obligation2 3) 1)(= (ASSOC 4)(union  (ASSOC 3) (singleton(mkTuple 7 34 16))))))(assert (=> (= (obligation2 3) 1)(= (ASSOC 4)(setminus  (ASSOC 3) (singleton(mkTuple 2 39 16))))))(assert (=> (= (obligation2 3) 1)(= (ASSOC 4)(setminus  (ASSOC 3) (singleton(mkTuple 2 34 16))))))
(assert (=> (= (obligation3 3) 1)(= (ASSOC 4)(union  (ASSOC 3) (singleton(mkTuple 9 39 16))))))(assert (=> (= (obligation3 3) 1)(= (ASSOC 4)(setminus  (ASSOC 3) (singleton(mkTuple 7 39 16))))))(assert (=> (= (obligation3 3) 1)(= (ASSIGN* 4)(union (join (join (union (singleton (mkTuple 12 12)) (join (ASSIGN* 3) (singleton (mkTuple 12 12)))) (singleton (mkTuple 12 3))) (union (singleton (mkTuple 3 3)) (join (singleton (mkTuple 3 3)) (ASSIGN* 3) ))) (ASSIGN* 3)))))
(assert (=> (= (obligation3 3) 1)(= (ASSIGN 4)(union (ASSIGN 3) (singleton (mkTuple 12 3))))))
(assert (=> (= (obligation4 3) 1)(= (ASSOC 4)(union  (ASSOC 3) (singleton(mkTuple 11 40 16))))))(assert (=> (= (obligation4 3) 1)(= (ASSOC 4)(setminus  (ASSOC 3) (singleton(mkTuple 9 39 16))))))(assert (=> (= (obligation4 3) 1)(= (ASSIGN 4)(setminus (ASSIGN* 3) (setminus (setminus (union (singleton (mkTuple 12 3)) (join (singleton (mkTuple 12 3)) (ASSIGN* 3))) (join (join (intersection (join (union  (singleton (mkTuple 12 12)) (join (ASSIGN* 3)  (singleton (mkTuple 12 12)))) (transpose (union  (singleton (mkTuple 12 12)) (join (ASSIGN* 3)  (singleton (mkTuple 12 12)))))) NODES) (setminus (ASSIGN 3) (singleton (mkTuple 12 3)))) (ASSIGN* 3))) (join (join (intersection (join (union  (singleton (mkTuple 12 12)) (join (ASSIGN* 3)  (singleton (mkTuple 12 12)))) (transpose (union  (singleton (mkTuple 12 12)) (join (ASSIGN* 3)  (singleton (mkTuple 12 12)))))) NODES) (setminus (ASSIGN 3) (singleton (mkTuple 12 3)))) (ASSIGN* 3)))))))
(assert (=> (= (obligation4 3) 1)(= (ASSIGN 4)(setminus (ASSIGN 3) (singleton (mkTuple 12 3))))))

(assert (=> (= (obligation5 3) 1)(= (ASSOC 4)(union  (ASSOC 3) (singleton(mkTuple 13 41 16))))))(assert (=> (= (obligation5 3) 1)(= (ASSOC 4)(setminus  (ASSOC 3) (singleton(mkTuple 11 40 16))))))
(assert (=> (= (obligation6 3) 1)(= (ASSOC 4)(union  (ASSOC 3) (singleton(mkTuple 18 39 16))))))(assert (=> (= (obligation6 3) 1)(= (ASSOC 4)(setminus  (ASSOC 3) (singleton(mkTuple 13 41 16))))))
(assert (=> (= (obligation7 3) 1)(= (ASSOC 4)(union  (ASSOC 3) (singleton(mkTuple 1 39 16))))))(assert (=> (= (obligation7 3) 1)(= (ASSOC 4)(setminus  (ASSOC 3) (singleton(mkTuple 18 39 16))))))
(assert (=> (= (obligation8 3) 1)(= (ASSOC 4)(union  (ASSOC 3) (singleton(mkTuple 8 39 16))))))(assert (=> (= (obligation8 3) 1)(= (ASSOC 4)(setminus  (ASSOC 3) (singleton(mkTuple 1 39 16))))))
(assert (=> (= (obligation9 3) 1)(= (ASSOC 4)(union  (ASSOC 3) (singleton(mkTuple 4 40 16))))))(assert (=> (= (obligation9 3) 1)(= (ASSOC 4)(setminus  (ASSOC 3) (singleton(mkTuple 8 39 16))))))
(assert (=> (= (obligation10 3) 1)(= (ASSOC 4)(union  (ASSOC 3) (singleton(mkTuple 5 41 16))))))(assert (=> (= (obligation10 3) 1)(= (ASSOC 4)(setminus  (ASSOC 3) (singleton(mkTuple 4 39 16))))))
(assert (=> (= (obligation11 3) 1)(= (ASSOC 4)(union  (ASSOC 3) (singleton(mkTuple 5 42 16))))))(assert (=> (= (obligation11 3) 1)(= (ASSOC 4)(setminus  (ASSOC 3) (singleton(mkTuple 5 41 16))))))
(assert (=> (= (obligation12 3) 1)(= (ASSOC 4)(union  (ASSOC 3) (singleton(mkTuple 4 44 16))))))(assert (=> (= (obligation12 3) 1)(= (ASSOC 4)(setminus  (ASSOC 3) (singleton(mkTuple 5 42 16))))))
(assert (=> (= (obligation13 3) 1)(= (ASSOC 4)(union  (ASSOC 3) (singleton(mkTuple 5 44 16))))))(assert (=> (= (obligation13 3) 1)(= (ASSOC 4)(setminus  (ASSOC 3) (singleton(mkTuple 4 44 16))))))
...
(assert (=> (= (obligation6 4) 1) (let((.def_U obligation6U_5)(.def_UO obligation6UO_5) (.def_UA obligation6UA_5)(.def_AT obligation6AT_5))(and
...
(assert (=> (= (obligation7 4) 1) (let((.def_U obligation7U_5)(.def_UO obligation7UO_5) (.def_UA obligation7UA_5)(.def_AT obligation7AT_5))(and
...
(assert (=> (= (obligation8 4) 1) (let((.def_U obligation8U_5)(.def_UO obligation8UO_5) (.def_UA obligation8UA_5)(.def_AT obligation8AT_5))(and
...
(assert (=> (= (obligation9 4) 1) (let((.def_U obligation9U_5)(.def_UO obligation9UO_5) (.def_UA obligation9UA_5)(.def_AT obligation9AT_5))(and
...
(assert (=> (= (obligation10 4) 1) (let((.def_U obligation10U_5)(.def_UO obligation10UO_5) (.def_UA obligation10UA_5)(.def_AT obligation10AT_5))(and
...
(assert (=> (= (obligation11 4) 1) (let((.def_U obligation11U_5)(.def_UO obligation11UO_5) (.def_UA obligation11UA_5)(.def_AT obligation11AT_5))(and
...
(assert (=> (= (obligation12 4) 1) (let((.def_U obligation12U_5)(.def_UO obligation12UO_5) (.def_UA obligation12UA_5)(.def_AT obligation12AT_5))(and
 (member (mkTuple  5 .def_UA) (ASSIGN* 4))
...
(assert (=> (= (obligation13 4) 1) (let((.def_U obligation13U_5)(.def_UO obligation13UO_5) (.def_UA obligation13UA_5)(.def_AT obligation13AT_5))(and
 (member (mkTuple  4 .def_UA) (ASSIGN* 4))
...
; 5.2 a->Eff
(assert (=> (= (obligation1 4) 1)(= (ASSOC 5)(union  (ASSOC 4) (singleton(mkTuple 2 39 16))))))(assert (=> (= (obligation1 4) 1)(= (ASSOC 5)(setminus  (ASSOC 4) (singleton(mkTuple 15 39 16))))))
(assert (=> (= (obligation2 4) 1)(= (ASSOC 5)(union  (ASSOC 4) (singleton(mkTuple 7 39 16))))))(assert (=> (= (obligation2 4) 1)(= (ASSOC 5)(union  (ASSOC 4) (singleton(mkTuple 7 34 16))))))(assert (=> (= (obligation2 4) 1)(= (ASSOC 5)(setminus  (ASSOC 4) (singleton(mkTuple 2 39 16))))))(assert (=> (= (obligation2 4) 1)(= (ASSOC 5)(setminus  (ASSOC 4) (singleton(mkTuple 2 34 16))))))
(assert (=> (= (obligation3 4) 1)(= (ASSOC 5)(union  (ASSOC 4) (singleton(mkTuple 9 39 16))))))(assert (=> (= (obligation3 4) 1)(= (ASSOC 5)(setminus  (ASSOC 4) (singleton(mkTuple 7 39 16))))))(assert (=> (= (obligation3 4) 1)(= (ASSIGN* 5)(union (join (join (union (singleton (mkTuple 12 12)) (join (ASSIGN* 4) (singleton (mkTuple 12 12)))) (singleton (mkTuple 12 3))) (union (singleton (mkTuple 3 3)) (join (singleton (mkTuple 3 3)) (ASSIGN* 4) ))) (ASSIGN* 4)))))
(assert (=> (= (obligation3 4) 1)(= (ASSIGN 5)(union (ASSIGN 4) (singleton (mkTuple 12 3))))))
(assert (=> (= (obligation4 4) 1)(= (ASSOC 5)(union  (ASSOC 4) (singleton(mkTuple 11 40 16))))))(assert (=> (= (obligation4 4) 1)(= (ASSOC 5)(setminus  (ASSOC 4) (singleton(mkTuple 9 39 16))))))(assert (=> (= (obligation4 4) 1)(= (ASSIGN 5)(setminus (ASSIGN* 4) (setminus (setminus (union (singleton (mkTuple 12 3)) (join (singleton (mkTuple 12 3)) (ASSIGN* 4))) (join (join (intersection (join (union  (singleton (mkTuple 12 12)) (join (ASSIGN* 4)  (singleton (mkTuple 12 12)))) (transpose (union  (singleton (mkTuple 12 12)) (join (ASSIGN* 4)  (singleton (mkTuple 12 12)))))) NODES) (setminus (ASSIGN 4) (singleton (mkTuple 12 3)))) (ASSIGN* 4))) (join (join (intersection (join (union  (singleton (mkTuple 12 12)) (join (ASSIGN* 4)  (singleton (mkTuple 12 12)))) (transpose (union  (singleton (mkTuple 12 12)) (join (ASSIGN* 4)  (singleton (mkTuple 12 12)))))) NODES) (setminus (ASSIGN 4) (singleton (mkTuple 12 3)))) (ASSIGN* 4)))))))
(assert (=> (= (obligation4 4) 1)(= (ASSIGN 5)(setminus (ASSIGN 4) (singleton (mkTuple 12 3))))))

(assert (=> (= (obligation5 4) 1)(= (ASSOC 5)(union  (ASSOC 4) (singleton(mkTuple 13 41 16))))))(assert (=> (= (obligation5 4) 1)(= (ASSOC 5)(setminus  (ASSOC 4) (singleton(mkTuple 11 40 16))))))
(assert (=> (= (obligation6 4) 1)(= (ASSOC 5)(union  (ASSOC 4) (singleton(mkTuple 18 39 16))))))(assert (=> (= (obligation6 4) 1)(= (ASSOC 5)(setminus  (ASSOC 4) (singleton(mkTuple 13 41 16))))))
(assert (=> (= (obligation7 4) 1)(= (ASSOC 5)(union  (ASSOC 4) (singleton(mkTuple 1 39 16))))))(assert (=> (= (obligation7 4) 1)(= (ASSOC 5)(setminus  (ASSOC 4) (singleton(mkTuple 18 39 16))))))
(assert (=> (= (obligation8 4) 1)(= (ASSOC 5)(union  (ASSOC 4) (singleton(mkTuple 8 39 16))))))(assert (=> (= (obligation8 4) 1)(= (ASSOC 5)(setminus  (ASSOC 4) (singleton(mkTuple 1 39 16))))))
(assert (=> (= (obligation9 4) 1)(= (ASSOC 5)(union  (ASSOC 4) (singleton(mkTuple 4 40 16))))))(assert (=> (= (obligation9 4) 1)(= (ASSOC 5)(setminus  (ASSOC 4) (singleton(mkTuple 8 39 16))))))
(assert (=> (= (obligation10 4) 1)(= (ASSOC 5)(union  (ASSOC 4) (singleton(mkTuple 5 41 16))))))(assert (=> (= (obligation10 4) 1)(= (ASSOC 5)(setminus  (ASSOC 4) (singleton(mkTuple 4 39 16))))))
(assert (=> (= (obligation11 4) 1)(= (ASSOC 5)(union  (ASSOC 4) (singleton(mkTuple 5 42 16))))))(assert (=> (= (obligation11 4) 1)(= (ASSOC 5)(setminus  (ASSOC 4) (singleton(mkTuple 5 41 16))))))
(assert (=> (= (obligation12 4) 1)(= (ASSOC 5)(union  (ASSOC 4) (singleton(mkTuple 4 44 16))))))(assert (=> (= (obligation12 4) 1)(= (ASSOC 5)(setminus  (ASSOC 4) (singleton(mkTuple 5 42 16))))))
(assert (=> (= (obligation13 4) 1)(= (ASSOC 5)(union  (ASSOC 4) (singleton(mkTuple 5 44 16))))))(assert (=> (= (obligation13 4) 1)(= (ASSOC 5)(setminus  (ASSOC 4) (singleton(mkTuple 4 44 16))))))
