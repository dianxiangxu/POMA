...
(assert (=> (= (obligation1 4) true)(subset (ASSIGN 5)(union (ASSIGN 4) (singleton (mkTuple 4 8))))))
...
(assert (=> (= (obligation2 4) true)(subset (ASSIGN 5)(union (ASSIGN 4) (singleton (mkTuple 6 4))))))
...
(assert (=> (= (obligation3 4) true)(subset (ASSIGN 5)(union (ASSIGN 4) (singleton (mkTuple 2 6))))))
