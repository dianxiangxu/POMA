...
(and (member (mkTuple 7 19 3) (ASSOC* 4))   (= (accept_refuse_case_A 4) 1))
)
)				
(assert 
(xor 
...
(and (member (mkTuple 7 19 3) (ASSOC* 4))   (= (accept_case_Final 4) 1))
)
)				
(assert 
(xor 
...
(xor (= (ASSOC 5) 
(setminus (union  (ASSOC 4) (singleton(mkTuple 6 19 3))) (singleton(mkTuple 7 20 13))))
(= (ASSOC 5) (ASSOC 4))))

(and  (= (withdraw_case_info 4) 1)
(xor (= (ASSOC 5) 
(union  (ASSOC 4) (singleton(mkTuple 7 19 13))))
(= (ASSOC 5) (ASSOC 4))))
