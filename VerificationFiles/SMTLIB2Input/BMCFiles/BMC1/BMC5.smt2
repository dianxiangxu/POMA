...
(assert (=> (=(obligation1 0) 1) (= (ASSOC 1) (ASSOC 0)))(assert (=> (= (obligation2 0) 1)(subset (ASSIGN* 1)(union (join (join (union (singleton (mkTuple 6 6)) (join (ASSIGN* 0) (singleton (mkTuple 6 6)))) (singleton (mkTuple 6 4))) (union (singleton (mkTuple 4 4)) (join (singleton (mkTuple 4 4)) (ASSIGN* 0) ))) (ASSIGN* 0)))))
(assert (=> (= (obligation2 0) 1)(subset (ASSIGN 1)(union (ASSIGN 0) (singleton (mkTuple 6 4))))))
(assert (=> (=(obligation2 0) 1) (= (ASSOC 1) (ASSOC 0)))(assert (=> (= (obligation3 0) 1)(subset (ASSIGN* 1)(union (join (join (union (singleton (mkTuple 2 2)) (join (ASSIGN* 0) (singleton (mkTuple 2 2)))) (singleton (mkTuple 2 6))) (union (singleton (mkTuple 6 6)) (join (singleton (mkTuple 6 6)) (ASSIGN* 0) ))) (ASSIGN* 0)))))
(assert (=> (= (obligation3 0) 1)(subset (ASSIGN 1)(union (ASSIGN 0) (singleton (mkTuple 2 6))))))
(assert (=> (=(obligation3 0) 1) (= (ASSOC 1) (ASSOC 0)))(assert (=> (= (obligation4 0) 1)(subset (ASSOC 1)(union  (ASSOC 0) (singleton(mkTuple 7 16 9))))))
...
(assert (=> (=(obligation1 1) 1) (= (ASSOC 2) (ASSOC 1)))(assert (=> (= (obligation2 1) 1)(subset (ASSIGN* 2)(union (join (join (union (singleton (mkTuple 6 6)) (join (ASSIGN* 1) (singleton (mkTuple 6 6)))) (singleton (mkTuple 6 4))) (union (singleton (mkTuple 4 4)) (join (singleton (mkTuple 4 4)) (ASSIGN* 1) ))) (ASSIGN* 1)))))
(assert (=> (= (obligation2 1) 1)(subset (ASSIGN 2)(union (ASSIGN 1) (singleton (mkTuple 6 4))))))
(assert (=> (=(obligation2 1) 1) (= (ASSOC 2) (ASSOC 1)))(assert (=> (= (obligation3 1) 1)(subset (ASSIGN* 2)(union (join (join (union (singleton (mkTuple 2 2)) (join (ASSIGN* 1) (singleton (mkTuple 2 2)))) (singleton (mkTuple 2 6))) (union (singleton (mkTuple 6 6)) (join (singleton (mkTuple 6 6)) (ASSIGN* 1) ))) (ASSIGN* 1)))))
(assert (=> (= (obligation3 1) 1)(subset (ASSIGN 2)(union (ASSIGN 1) (singleton (mkTuple 2 6))))))
(assert (=> (=(obligation3 1) 1) (= (ASSOC 2) (ASSOC 1)))(assert (=> (= (obligation4 1) 1)(subset (ASSOC 2)(union  (ASSOC 1) (singleton(mkTuple 7 16 9))))))
...
(assert (=> (=(obligation1 2) 1) (= (ASSOC 3) (ASSOC 2)))(assert (=> (= (obligation2 2) 1)(subset (ASSIGN* 3)(union (join (join (union (singleton (mkTuple 6 6)) (join (ASSIGN* 2) (singleton (mkTuple 6 6)))) (singleton (mkTuple 6 4))) (union (singleton (mkTuple 4 4)) (join (singleton (mkTuple 4 4)) (ASSIGN* 2) ))) (ASSIGN* 2)))))
(assert (=> (= (obligation2 2) 1)(subset (ASSIGN 3)(union (ASSIGN 2) (singleton (mkTuple 6 4))))))
(assert (=> (=(obligation2 2) 1) (= (ASSOC 3) (ASSOC 2)))(assert (=> (= (obligation3 2) 1)(subset (ASSIGN* 3)(union (join (join (union (singleton (mkTuple 2 2)) (join (ASSIGN* 2) (singleton (mkTuple 2 2)))) (singleton (mkTuple 2 6))) (union (singleton (mkTuple 6 6)) (join (singleton (mkTuple 6 6)) (ASSIGN* 2) ))) (ASSIGN* 2)))))
(assert (=> (= (obligation3 2) 1)(subset (ASSIGN 3)(union (ASSIGN 2) (singleton (mkTuple 2 6))))))
(assert (=> (=(obligation3 2) 1) (= (ASSOC 3) (ASSOC 2)))(assert (=> (= (obligation4 2) 1)(subset (ASSOC 3)(union  (ASSOC 2) (singleton(mkTuple 7 16 9))))))
...
(assert (=> (=(obligation1 3) 1) (= (ASSOC 4) (ASSOC 3)))(assert (=> (= (obligation2 3) 1)(subset (ASSIGN* 4)(union (join (join (union (singleton (mkTuple 6 6)) (join (ASSIGN* 3) (singleton (mkTuple 6 6)))) (singleton (mkTuple 6 4))) (union (singleton (mkTuple 4 4)) (join (singleton (mkTuple 4 4)) (ASSIGN* 3) ))) (ASSIGN* 3)))))
(assert (=> (= (obligation2 3) 1)(subset (ASSIGN 4)(union (ASSIGN 3) (singleton (mkTuple 6 4))))))
(assert (=> (=(obligation2 3) 1) (= (ASSOC 4) (ASSOC 3)))(assert (=> (= (obligation3 3) 1)(subset (ASSIGN* 4)(union (join (join (union (singleton (mkTuple 2 2)) (join (ASSIGN* 3) (singleton (mkTuple 2 2)))) (singleton (mkTuple 2 6))) (union (singleton (mkTuple 6 6)) (join (singleton (mkTuple 6 6)) (ASSIGN* 3) ))) (ASSIGN* 3)))))
(assert (=> (= (obligation3 3) 1)(subset (ASSIGN 4)(union (ASSIGN 3) (singleton (mkTuple 2 6))))))
(assert (=> (=(obligation3 3) 1) (= (ASSOC 4) (ASSOC 3)))(assert (=> (= (obligation4 3) 1)(subset (ASSOC 4)(union  (ASSOC 3) (singleton(mkTuple 7 16 9))))))
...
(assert (=> (= (obligation1 4) 1) (let((.def_U obligation1U_5)(.def_UO obligation1UO_5) (.def_UA obligation1UA_5)(.def_AT obligation1AT_5))(and
...
(assert (=> (= (obligation2 4) 1) (let((.def_U obligation2U_5)(.def_UO obligation2UO_5) (.def_UA obligation2UA_5)(.def_AT obligation2AT_5))(and
...
(assert (=> (= (obligation3 4) 1) (let((.def_U obligation3U_5)(.def_UO obligation3UO_5) (.def_UA obligation3UA_5)(.def_AT obligation3AT_5))(and
...
(assert (=> (= (obligation4 4) 1) (let((.def_U obligation4U_5)(.def_UO obligation4UO_5) (.def_UA obligation4UA_5)(.def_AT obligation4AT_5))(and
...
(assert (=> (= (obligation5 4) 1) (let((.def_U obligation5U_5)(.def_UO obligation5UO_5) (.def_UA obligation5UA_5)(.def_AT obligation5AT_5))(and
 (member (mkTuple  8 .def_UA) (ASSIGN* 4))
...
; 5.2 a->Eff
(assert (=> (= (obligation1 4) 1)(subset (ASSIGN* 5) (union (singleton (mkTuple 4 8)) (union (join (singleton (mkTuple 4 8)) (join (singleton (mkTuple 8 8)) (ASSIGN* 4))) (ASSIGN* 4))))))
(assert (=> (= (obligation1 4) 1)(subset (ASSIGN 5)(union (ASSIGN 4) (singleton (mkTuple 4 8))))))
(assert (=> (=(obligation1 4) 1) (= (ASSOC 5) (ASSOC 4)))(assert (=> (= (obligation2 4) 1)(subset (ASSIGN* 5)(union (join (join (union (singleton (mkTuple 6 6)) (join (ASSIGN* 4) (singleton (mkTuple 6 6)))) (singleton (mkTuple 6 4))) (union (singleton (mkTuple 4 4)) (join (singleton (mkTuple 4 4)) (ASSIGN* 4) ))) (ASSIGN* 4)))))
(assert (=> (= (obligation2 4) 1)(subset (ASSIGN 5)(union (ASSIGN 4) (singleton (mkTuple 6 4))))))
(assert (=> (=(obligation2 4) 1) (= (ASSOC 5) (ASSOC 4)))(assert (=> (= (obligation3 4) 1)(subset (ASSIGN* 5)(union (join (join (union (singleton (mkTuple 2 2)) (join (ASSIGN* 4) (singleton (mkTuple 2 2)))) (singleton (mkTuple 2 6))) (union (singleton (mkTuple 6 6)) (join (singleton (mkTuple 6 6)) (ASSIGN* 4) ))) (ASSIGN* 4)))))
(assert (=> (= (obligation3 4) 1)(subset (ASSIGN 5)(union (ASSIGN 4) (singleton (mkTuple 2 6))))))
(assert (=> (=(obligation3 4) 1) (= (ASSOC 5) (ASSOC 4)))(assert (=> (= (obligation4 4) 1)(subset (ASSOC 5)(union  (ASSOC 4) (singleton(mkTuple 7 16 9))))))
(assert (=> (= (obligation5 4) 1)(= (ASSIGN* 5)(setminus (ASSIGN* 4) (setminus (setminus (union (singleton (mkTuple 6 8)) (join (singleton (mkTuple 6 8)) (ASSIGN* 4))) (join (join (intersection (join (union  (singleton (mkTuple 6 6)) (join (ASSIGN* 4)  (singleton (mkTuple 6 6)))) (transpose (union  (singleton (mkTuple 6 6)) (join (ASSIGN* 4)  (singleton (mkTuple 6 6)))))) NODES) (setminus (ASSIGN 4) (singleton (mkTuple 6 8)))) (ASSIGN* 4))) (join (join (intersection (join (union  (singleton (mkTuple 6 6)) (join (ASSIGN* 4)  (singleton (mkTuple 6 6)))) (transpose (union  (singleton (mkTuple 6 6)) (join (ASSIGN* 4)  (singleton (mkTuple 6 6)))))) NODES) (setminus (ASSIGN 4) (singleton (mkTuple 6 8)))) (ASSIGN* 4)))))))
(assert (=> (= (obligation5 4) 1)(= (ASSIGN 5)(setminus (ASSIGN 4) (singleton (mkTuple 6 8))))))

(assert (=> (=(obligation5 4) 1) (= (ASSOC 5) (ASSOC 4)))

; 5.3 change implies the execution
(assert (=> (distinct (ASSIGN* 5) (ASSIGN* 4))
(or 
(= (obligation3 4) 1)(= (obligation2 4) 1)(= (obligation5 4) 1)(= (obligation4 4) 1)(= (obligation1 4) 1))))
...
; AT MOST ONE
(assert (not (and (= (obligation3 4) 1) (= (obligation2 4) 1))))
(assert (not (and (= (obligation3 4) 1) (= (obligation5 4) 1))))
(assert (not (and (= (obligation3 4) 1) (= (obligation4 4) 1))))
(assert (not (and (= (obligation3 4) 1) (= (obligation1 4) 1))))
(assert (not (and (= (obligation2 4) 1) (= (obligation5 4) 1))))
(assert (not (and (= (obligation2 4) 1) (= (obligation4 4) 1))))
(assert (not (and (= (obligation2 4) 1) (= (obligation1 4) 1))))
(assert (not (and (= (obligation5 4) 1) (= (obligation4 4) 1))))
(assert (not (and (= (obligation5 4) 1) (= (obligation1 4) 1))))
(assert (not (and (= (obligation4 4) 1) (= (obligation1 4) 1))))

; AT LEAST ONE
(assert (or(= (obligation3 4) 1)(= (obligation2 4) 1)(= (obligation5 4) 1)(= (obligation4 4) 1)(= (obligation1 4) 1)))


;QUERY
(assert (= (obligation4 4) 1))
