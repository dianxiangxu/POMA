...
(and (= (submit_proposal 1) true)
 (= submit_proposalU_1 queryVARu0 ) (= submit_proposalar_1 queryVARar0 ) (= submit_proposalT_1 queryVARat0 )))
...
(assert 
(and (= (chair_approve 2) true)
 (= chair_approveU_2 queryVARu ) (= chair_approvear_2 queryVARar ) (= chair_approveT_2 queryVARat )))
(check-sat)
