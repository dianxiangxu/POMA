...
(assert (=> (=(obligation1 0) true) (= (ASSIGN 1) (ASSIGN 0))))
(assert (=> (= (obligation1 0) true)(= (ASSOC 1) (setminus(union(union(ASSOC 0)(singleton(mkTuple 2 30 15)))(singleton(mkTuple 2 26 15)))(singleton(mkTuple 14 26 15))))))
...
(assert (or (= obligation7ar_1 30)
))
(assert (= obligation7S_1 17))
(assert (= obligation7T_1 15))
...
(assert (=> (=(obligation1 1) true) (= (ASSIGN 2) (ASSIGN 1))))
(assert (=> (= (obligation1 1) true)(= (ASSOC 2) (setminus(union(union(ASSOC 1)(singleton(mkTuple 2 30 15)))(singleton(mkTuple 2 26 15)))(singleton(mkTuple 14 26 15))))))
...
(assert (=> (=(obligation2 1) true) (= (ASSIGN 2) (ASSIGN 1))))
(assert (=> (= (obligation2 1) true)(= (ASSOC 2) (setminus(union(ASSOC 1)(singleton(mkTuple 7 30 15)))(singleton(mkTuple 2 30 15))))))
...
(assert (=> (=(obligation3 1) true) (= (ASSIGN 2) (ASSIGN 1))))
(assert (=> (= (obligation3 1) true)(= (ASSOC 2) (setminus(union(ASSOC 1)(singleton(mkTuple 9 30 15)))(singleton(mkTuple 7 30 15))))))
...
(assert (=> (=(obligation4 1) true) (= (ASSIGN 2) (ASSIGN 1))))
(assert (=> (= (obligation4 1) true)(= (ASSOC 2) (setminus(union(ASSOC 1)(singleton(mkTuple 10 27 15)))(singleton(mkTuple 9 30 15))))))
...
(assert (=> (=(obligation6 1) true) (= (ASSIGN 2) (ASSIGN 1))))
(assert (=> (= (obligation6 1) true)(= (ASSOC 2) (setminus(union(ASSOC 1)(singleton(mkTuple 17 30 15)))(singleton(mkTuple 12 28 15))))))
...
(assert (=> (=(obligation7 1) true) (= (ASSIGN 2) (ASSIGN 1))))
(assert (=> (= (obligation7 1) true)(= (ASSOC 2) (setminus(union(ASSOC 1)(singleton(mkTuple 1 30 15)))(singleton(mkTuple 17 30 15))))))
...
(assert (or (= obligation7ar_2 30)
))
(assert (= obligation7S_2 17))
(assert (= obligation7T_2 15))
...
(assert (=> (=(obligation1 2) true) (= (ASSIGN 3) (ASSIGN 2))))
(assert (=> (= (obligation1 2) true)(= (ASSOC 3) (setminus(union(union(ASSOC 2)(singleton(mkTuple 2 30 15)))(singleton(mkTuple 2 26 15)))(singleton(mkTuple 14 26 15))))))
...
(assert (=> (=(obligation2 2) true) (= (ASSIGN 3) (ASSIGN 2))))
(assert (=> (= (obligation2 2) true)(= (ASSOC 3) (setminus(union(ASSOC 2)(singleton(mkTuple 7 30 15)))(singleton(mkTuple 2 30 15))))))
...
(assert (=> (=(obligation3 2) true) (= (ASSIGN 3) (ASSIGN 2))))
(assert (=> (= (obligation3 2) true)(= (ASSOC 3) (setminus(union(ASSOC 2)(singleton(mkTuple 9 30 15)))(singleton(mkTuple 7 30 15))))))
...
(assert (=> (=(obligation4 2) true) (= (ASSIGN 3) (ASSIGN 2))))
(assert (=> (= (obligation4 2) true)(= (ASSOC 3) (setminus(union(ASSOC 2)(singleton(mkTuple 10 27 15)))(singleton(mkTuple 9 30 15))))))
...
(assert (=> (=(obligation6 2) true) (= (ASSIGN 3) (ASSIGN 2))))
(assert (=> (= (obligation6 2) true)(= (ASSOC 3) (setminus(union(ASSOC 2)(singleton(mkTuple 17 30 15)))(singleton(mkTuple 12 28 15))))))
...
(assert (=> (=(obligation7 2) true) (= (ASSIGN 3) (ASSIGN 2))))
(assert (=> (= (obligation7 2) true)(= (ASSOC 3) (setminus(union(ASSOC 2)(singleton(mkTuple 1 30 15)))(singleton(mkTuple 17 30 15))))))
...
(assert (not 
(member (mkTuple  14  27  15 ) (ASSOC 3))
))

(declare-fun queryVARPERMITUA_PI_submit_PDSWhole_2 () Int)
(declare-fun queryVARPERMITAT_PI_submit_PDSWhole_2 () Int)
(assert (and (and 
(and (= (obligation1 2) true)
 (= obligation1S_2 14 ) (= obligation1ar_2 27 ) (= obligation1T_2 15 )) 
(and(member (mkTuple  14  queryVARPERMITUA_PI_submit_PDSWhole_2 ) (ASSIGN* 2))(member (mkTuple  queryVARPERMITUA_PI_submit_PDSWhole_2 27  queryVARPERMITAT_PI_submit_PDSWhole_2 ) (ASSOC 2))(member (mkTuple  15  queryVARPERMITAT_PI_submit_PDSWhole_2 ) (ASSIGN* 2)))
) 
(member (mkTuple  14  27  15 ) (ASSOC 2))
))
(check-sat)
