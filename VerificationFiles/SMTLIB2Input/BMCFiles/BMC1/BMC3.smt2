...
(or 
(= (obligation3 2) true)(= (obligation2 2) true)(= (obligation4 2) true)(= (obligation1 2) true))))
(assert (=> (distinct (ASSIGN 3) (ASSIGN 2))
(or (= (obligation3 2) true)(= (obligation2 2) true)(= (obligation4 2) true)(= (obligation1 2) true))))
...
; 5.4 Exactly one naive
; AT LEAST ONE
(assert (or(= (obligation3 2) true)(= (obligation2 2) true)(= (obligation4 2) true)(= (obligation1 2) true)))


(assert (not 
(member (mkTuple  6  8 ) (ASSIGN 3))
))
...
(declare-fun queryVARASSOCAR_Attorneys2_?ar_?at_1 () Int)
(declare-fun queryVARASSOCAT_Attorneys2_?ar_?at_1 () Int)
...
(declare-fun queryVARASSOCUA_?s_?ar_Attorneys2_1 () Int)
(declare-fun queryVARASSOCAR_?s_?ar_Attorneys2_1 () Int)
(declare-fun queryVARPERMITU_?s_?ar_Attorneys_2 () Int)
(declare-fun queryVARPERMITUA_?s_?ar_Attorneys_2 () Int)
(declare-fun queryVARPERMITAR_?s_?ar_Attorneys_2 () Int)
(declare-fun queryVARPERMITAT_?s_?ar_Attorneys_2 () Int)
...
(member (mkTuple  6  8 ) (setminus (ASSIGN* 2)(ASSIGN 2)))
)) 
(member (mkTuple  6  queryVARASSOCAR_Attorneys2_?ar_?at_1  queryVARASSOCAT_Attorneys2_?ar_?at_1 ) (ASSOC 2))
) (not 
...
(member (mkTuple  queryVARASSOCUA_?s_?ar_Attorneys2_1  queryVARASSOCAR_?s_?ar_Attorneys2_1  6 ) (ASSOC 2))
) (not 
(and(member (mkTuple   queryVARPERMITU_?s_?ar_Attorneys_2  queryVARPERMITUA_?s_?ar_Attorneys_2 ) (ASSIGN* 2))(member (mkTuple  queryVARPERMITUA_?s_?ar_Attorneys_2  queryVARPERMITAR_?s_?ar_Attorneys_2  queryVARPERMITAT_?s_?ar_Attorneys_2 ) (ASSOC 2))(member (mkTuple  8  queryVARPERMITAT_?s_?ar_Attorneys_2 ) (ASSIGN* 2)))
)) 
(and (= (obligation5 2) true)
 (= obligation5S_2 8 ) (= obligation5ar_2 14 ) (= obligation5T_2 1 ))))
(check-sat)
