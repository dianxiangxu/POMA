...
(declare-fun queryVARASSIGN*D_Attorneys1_1 () Int)
(declare-fun queryVARASSIGN*D_Attorneys_1 () Int)
(declare-fun queryVARPERMITUA_Attorneys_?ar_?at_2 () Int)
(declare-fun queryVARPERMITAR_Attorneys_?ar_?at_2 () Int)
(declare-fun queryVARPERMITAT_Attorneys_?ar_?at_2 () Int)
(declare-fun queryVARPERMITUO_Attorneys_?ar_?at_2 () Int)
(declare-fun queryVARPERMITUA_Attorneys1_?ar_?at_2 () Int)
(declare-fun queryVARPERMITAR_Attorneys1_?ar_?at_2 () Int)
(declare-fun queryVARPERMITAT_Attorneys1_?ar_?at_2 () Int)
(declare-fun queryVARPERMITUO_Attorneys1_?ar_?at_2 () Int)
...
(member (mkTuple  4  queryVARASSIGN*D_Attorneys1_1 ) (ASSIGN* 2))
) 
(member (mkTuple  8  queryVARASSIGN*D_Attorneys_1 ) (ASSIGN* 2))
) (not 
(member (mkTuple  4  8 ) (ASSIGN 2))
)) 
(and(member (mkTuple  8  queryVARPERMITUA_Attorneys_?ar_?at_2 ) (ASSIGN* 2))(member (mkTuple  queryVARPERMITUA_Attorneys_?ar_?at_2  queryVARPERMITAR_Attorneys_?ar_?at_2  queryVARPERMITAT_Attorneys_?ar_?at_2 ) (ASSOC 2))(member (mkTuple   queryVARPERMITUO_Attorneys_?ar_?at_2  queryVARPERMITAT_Attorneys_?ar_?at_2 ) (ASSIGN* 2)))
) (not 
(and(member (mkTuple  4  queryVARPERMITUA_Attorneys1_?ar_?at_2 ) (ASSIGN* 2))(member (mkTuple  queryVARPERMITUA_Attorneys1_?ar_?at_2  queryVARPERMITAR_Attorneys1_?ar_?at_2  queryVARPERMITAT_Attorneys1_?ar_?at_2 ) (ASSOC 2))(member (mkTuple   queryVARPERMITUO_Attorneys1_?ar_?at_2  queryVARPERMITAT_Attorneys1_?ar_?at_2 ) (ASSIGN* 2)))
)) 
