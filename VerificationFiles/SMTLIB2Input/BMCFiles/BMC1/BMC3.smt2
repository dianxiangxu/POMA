...
(xor 
(= (obligation1 0) 0) 
(and (member (mkTuple 15 40 16) (ASSOC* 0))  (member (mkTuple 3 17) (ASSIGN* 0)) (= (obligation1 0) 1))
)
)				
(assert 
(xor 
...
(= (ASSIGN 1) (ASSIGN 0))))
(assert (or 
(and (member (mkTuple 3 17) (ASSIGN* 0)) (= (obligation1 0) 1)
(xor (= (ASSOC 1) 
...
(xor 
(= (obligation1 1) 0) 
(and (member (mkTuple 15 40 16) (ASSOC* 1))  (member (mkTuple 3 17) (ASSIGN* 1)) (= (obligation1 1) 1))
)
)				
(assert 
(xor 
...
(= (ASSIGN 2) (ASSIGN 1))))
(assert (or 
(and (member (mkTuple 3 17) (ASSIGN* 1)) (= (obligation1 1) 1)
(xor (= (ASSOC 2) 
...
(xor 
(= (obligation1 2) 0) 
(and (member (mkTuple 15 40 16) (ASSOC* 2))  (member (mkTuple 3 17) (ASSIGN* 2)) (= (obligation1 2) 1))
)
)				
(assert 
(xor 
...
(= (ASSIGN 3) (ASSIGN 2))))
(assert (or 
(and (member (mkTuple 3 17) (ASSIGN* 2)) (= (obligation1 2) 1)
(xor (= (ASSOC 3) 
...
;QUERY
(assert (member (mkTuple  12 10) (ASSIGN* 3)))
