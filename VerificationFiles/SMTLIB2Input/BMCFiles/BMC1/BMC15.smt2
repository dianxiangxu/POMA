...
(assert (or (= obligation0ar_10 27)
))
(assert (= obligation0S_10 19))
...
(declare-fun obligation0_AssignAction_11_0 () (Set (Tuple Int Int)))

(declare-fun obligation0_AssignAction_11_0_* () (Set (Tuple Int Int)))
...
(and
	...
	(and
		...
		;ACTION: obligation0_AssignAction_11_0
		(=>(and(not (set.member (tuple 17 16) (ASSIGN 10)))(not (= 17 16))(not (set.member (tuple 16 17) (ASSIGN* 10)))) (and (= obligation0_AssignAction_11_0 (set.singleton( tuple 17 16))) (= obligation0_AssignAction_11_0_* (set.union (set.singleton (tuple 17 16)) (rel.join (set.singleton (tuple 17 16)) (rel.join (set.singleton (tuple 16 16)) (ASSIGN* 10)))))))

		(=>(not (and(not (set.member (tuple 17 16) (ASSIGN 10)))(not (= 17 16))(not (set.member (tuple 16 17) (ASSIGN* 10))))) (and (= obligation0_AssignAction_11_0 (as set.empty (Set (Tuple Int Int)))) (= obligation0_AssignAction_11_0_* (as set.empty (Set (Tuple Int Int))))))

	)
)
)
)(assert (=> (= ( obligation0 10) false) (and(= obligation0_AssignAction_11_0 (as set.empty (Set (Tuple Int Int))))(= obligation0_AssignAction_11_0_* (as set.empty (Set (Tuple Int Int)))))))



(declare-fun obligation1_AssignAction_11_0 () (Set (Tuple Int Int)))

(declare-fun obligation1_AssignAction_11_1 () (Set (Tuple Int Int)))

(declare-fun obligation1_AssignAction_11_0_* () (Set (Tuple Int Int)))

(declare-fun obligation1_AssignAction_11_1_* () (Set (Tuple Int Int)))
...
(or
	(and
	;NEGATED PRECONDITION: obligation1_AssignAction_11_1
	(not 	(and
		(and 
			(not (set.member (tuple 15 18) (ASSIGN 10))) 
			(not (set.subset (set.singleton(tuple 15 18)) (set.union (set.singleton (tuple 15 18)) (rel.join (set.singleton (tuple 15 18)) (rel.join (set.singleton (tuple 18 18)) (ASSIGN* 10)))) )		)
		)
		(and 
			(not (set.member (tuple 18 15) (ASSIGN 10))) 
			(not (set.subset (set.singleton(tuple 18 15)) (set.union (set.singleton (tuple 15 18)) (rel.join (set.singleton (tuple 15 18)) (rel.join (set.singleton (tuple 18 18)) (ASSIGN* 10)))) )		)
		)
	))
	;NEGATED POSTCONDITION: obligation1_AssignAction_11_1
	(= obligation1_AssignAction_11_1 (as set.empty (Set (Tuple Int Int))))
	)

	(and
	;PRECONDITION: obligation1_AssignAction_11_1
	(and
		(and 
			(not (set.member (tuple 15 18) (ASSIGN 10))) 
			(not (set.subset (set.singleton(tuple 15 18)) (set.union (set.singleton (tuple 15 18)) (rel.join (set.singleton (tuple 15 18)) (rel.join (set.singleton (tuple 18 18)) (ASSIGN* 10)))) )		)
	...
	;POSTCONDITION: obligation1_AssignAction_11_1
	(= obligation1_AssignAction_11_1 (set.singleton( tuple 15 18)))
	)
)
	...
	(and
		...
		;ACTION: obligation1_AssignAction_11_0
		(=>(and(not (set.member (tuple 15 18) (ASSIGN 10)))(not (= 15 18))(not (set.member (tuple 18 15) (ASSIGN* 10)))) (and (= obligation1_AssignAction_11_0 (set.singleton( tuple 15 18))) (= obligation1_AssignAction_11_0_* (set.union (set.singleton (tuple 15 18)) (rel.join (set.singleton (tuple 15 18)) (rel.join (set.singleton (tuple 18 18)) (ASSIGN* 10)))))))

		(=>(not (and(not (set.member (tuple 15 18) (ASSIGN 10)))(not (= 15 18))(not (set.member (tuple 18 15) (ASSIGN* 10))))) (and (= obligation1_AssignAction_11_0 (as set.empty (Set (Tuple Int Int)))) (= obligation1_AssignAction_11_0_* (as set.empty (Set (Tuple Int Int))))))

	)
)
)
)(assert (=> (= ( obligation1 10) false) (and(= obligation1_AssignAction_11_0 (as set.empty (Set (Tuple Int Int))))(= obligation1_AssignAction_11_1 (as set.empty (Set (Tuple Int Int))))(= obligation1_AssignAction_11_0_* (as set.empty (Set (Tuple Int Int))))(= obligation1_AssignAction_11_1_* (as set.empty (Set (Tuple Int Int)))))))



;RELATION TRANSITION ENCODING
(assert (= (ASSIGN 11) 
	(set.union (ASSIGN 10) (set.union obligation1_AssignAction_11_1 (set.union obligation1_AssignAction_11_0  obligation0_AssignAction_11_0)))
))
(assert (= (ASSIGN* 11) 
	(set.union (ASSIGN* 10) (set.union obligation1_AssignAction_11_1_* (set.union obligation1_AssignAction_11_0_*  obligation0_AssignAction_11_0_*)))
))
(assert (= (ASSOC 11) (ASSOC 10)))

; 5.3 change implies the execution
(assert (=> (distinct (ASSIGN* 11) (ASSIGN* 10))
(or 
(= (obligation0 10) true)(= (obligation1 10) true))))
(assert (=> (distinct (ASSIGN 11) (ASSIGN 10))
(or (= (obligation0 10) true)(= (obligation1 10) true))))
...
; 5.4 Exactly one naive
; AT LEAST ONE
(assert (or(= (obligation1 10) true)(= (obligation0 10) true)))
...
(assert (or (= obligation0ar_11 27)
))
(assert (= obligation0S_11 19))
...
(declare-fun obligation0_AssignAction_12_0 () (Set (Tuple Int Int)))

(declare-fun obligation0_AssignAction_12_0_* () (Set (Tuple Int Int)))
...
(and
	...
	(and
		...
		;ACTION: obligation0_AssignAction_12_0
		(=>(and(not (set.member (tuple 17 16) (ASSIGN 11)))(not (= 17 16))(not (set.member (tuple 16 17) (ASSIGN* 11)))) (and (= obligation0_AssignAction_12_0 (set.singleton( tuple 17 16))) (= obligation0_AssignAction_12_0_* (set.union (set.singleton (tuple 17 16)) (rel.join (set.singleton (tuple 17 16)) (rel.join (set.singleton (tuple 16 16)) (ASSIGN* 11)))))))

		(=>(not (and(not (set.member (tuple 17 16) (ASSIGN 11)))(not (= 17 16))(not (set.member (tuple 16 17) (ASSIGN* 11))))) (and (= obligation0_AssignAction_12_0 (as set.empty (Set (Tuple Int Int)))) (= obligation0_AssignAction_12_0_* (as set.empty (Set (Tuple Int Int))))))

	)
)
)
)(assert (=> (= ( obligation0 11) false) (and(= obligation0_AssignAction_12_0 (as set.empty (Set (Tuple Int Int))))(= obligation0_AssignAction_12_0_* (as set.empty (Set (Tuple Int Int)))))))



(declare-fun obligation1_AssignAction_12_0 () (Set (Tuple Int Int)))

(declare-fun obligation1_AssignAction_12_1 () (Set (Tuple Int Int)))

(declare-fun obligation1_AssignAction_12_0_* () (Set (Tuple Int Int)))

(declare-fun obligation1_AssignAction_12_1_* () (Set (Tuple Int Int)))
...
(or
	(and
	;NEGATED PRECONDITION: obligation1_AssignAction_12_1
	(not 	(and
		(and 
			(not (set.member (tuple 15 18) (ASSIGN 11))) 
			(not (set.subset (set.singleton(tuple 15 18)) (set.union (set.singleton (tuple 15 18)) (rel.join (set.singleton (tuple 15 18)) (rel.join (set.singleton (tuple 18 18)) (ASSIGN* 11)))) )		)
		)
		(and 
			(not (set.member (tuple 18 15) (ASSIGN 11))) 
			(not (set.subset (set.singleton(tuple 18 15)) (set.union (set.singleton (tuple 15 18)) (rel.join (set.singleton (tuple 15 18)) (rel.join (set.singleton (tuple 18 18)) (ASSIGN* 11)))) )		)
		)
	))
	;NEGATED POSTCONDITION: obligation1_AssignAction_12_1
	(= obligation1_AssignAction_12_1 (as set.empty (Set (Tuple Int Int))))
	)

	(and
	;PRECONDITION: obligation1_AssignAction_12_1
	(and
		(and 
			(not (set.member (tuple 15 18) (ASSIGN 11))) 
			(not (set.subset (set.singleton(tuple 15 18)) (set.union (set.singleton (tuple 15 18)) (rel.join (set.singleton (tuple 15 18)) (rel.join (set.singleton (tuple 18 18)) (ASSIGN* 11)))) )		)
	...
	;POSTCONDITION: obligation1_AssignAction_12_1
	(= obligation1_AssignAction_12_1 (set.singleton( tuple 15 18)))
	)
)
	...
	(and
		...
		;ACTION: obligation1_AssignAction_12_0
		(=>(and(not (set.member (tuple 15 18) (ASSIGN 11)))(not (= 15 18))(not (set.member (tuple 18 15) (ASSIGN* 11)))) (and (= obligation1_AssignAction_12_0 (set.singleton( tuple 15 18))) (= obligation1_AssignAction_12_0_* (set.union (set.singleton (tuple 15 18)) (rel.join (set.singleton (tuple 15 18)) (rel.join (set.singleton (tuple 18 18)) (ASSIGN* 11)))))))

		(=>(not (and(not (set.member (tuple 15 18) (ASSIGN 11)))(not (= 15 18))(not (set.member (tuple 18 15) (ASSIGN* 11))))) (and (= obligation1_AssignAction_12_0 (as set.empty (Set (Tuple Int Int)))) (= obligation1_AssignAction_12_0_* (as set.empty (Set (Tuple Int Int))))))

	)
)
)
)(assert (=> (= ( obligation1 11) false) (and(= obligation1_AssignAction_12_0 (as set.empty (Set (Tuple Int Int))))(= obligation1_AssignAction_12_1 (as set.empty (Set (Tuple Int Int))))(= obligation1_AssignAction_12_0_* (as set.empty (Set (Tuple Int Int))))(= obligation1_AssignAction_12_1_* (as set.empty (Set (Tuple Int Int)))))))



;RELATION TRANSITION ENCODING
(assert (= (ASSIGN 12) 
	(set.union (ASSIGN 11) (set.union obligation1_AssignAction_12_1 (set.union obligation1_AssignAction_12_0  obligation0_AssignAction_12_0)))
))
(assert (= (ASSIGN* 12) 
	(set.union (ASSIGN* 11) (set.union obligation1_AssignAction_12_1_* (set.union obligation1_AssignAction_12_0_*  obligation0_AssignAction_12_0_*)))
))
(assert (= (ASSOC 12) (ASSOC 11)))

; 5.3 change implies the execution
(assert (=> (distinct (ASSIGN* 12) (ASSIGN* 11))
(or 
(= (obligation0 11) true)(= (obligation1 11) true))))
(assert (=> (distinct (ASSIGN 12) (ASSIGN 11))
(or (= (obligation0 11) true)(= (obligation1 11) true))))
...
; 5.4 Exactly one naive
; AT LEAST ONE
(assert (or(= (obligation1 11) true)(= (obligation0 11) true)))
...
; 5.1 a->PRE
(declare-fun obligation0U_12 () Int)
(declare-fun obligation0UA_12 () Int)
(declare-fun obligation0AT_12 () Int)
(declare-fun obligation0UO_12 () Int)
(declare-fun obligation0ar_12 () Int)
(declare-fun obligation0S_12 () Int)
(declare-fun obligation0T_12 () Int)
(assert (>= obligation0U_12 0))
(assert (>= obligation0UA_12 0))
(assert (>= obligation0AT_12 0))
(assert (>= obligation0UO_12 0))
(assert (or (= obligation0ar_12 27)
))
(assert (= obligation0S_12 19))
(assert (= obligation0T_12 20))
(assert (=> (= (obligation0 12) true) (and
 (set.member (tuple  obligation0U_12 obligation0S_12) (ASSIGN* 12))
 (set.member (tuple  obligation0U_12 obligation0UA_12) (ASSIGN* 12))
 (set.member (tuple obligation0UA_12 obligation0ar_12 obligation0AT_12) (ASSOC 12))
 (set.member (tuple  obligation0UO_12 obligation0T_12) (ASSIGN* 12))
 (set.member (tuple  obligation0UO_12 obligation0AT_12) (ASSIGN* 12))
 (set.member (tuple  obligation0U_12 obligation0U_12) USERS)
 (distinct obligation0S_12 obligation0U_12)
)))


(declare-fun obligation1U_12 () Int)
(declare-fun obligation1UA_12 () Int)
(declare-fun obligation1AT_12 () Int)
(declare-fun obligation1UO_12 () Int)
(declare-fun obligation1ar_12 () Int)
(declare-fun obligation1S_12 () Int)
(declare-fun obligation1T_12 () Int)
(assert (>= obligation1U_12 0))
(assert (>= obligation1UA_12 0))
(assert (>= obligation1AT_12 0))
(assert (>= obligation1UO_12 0))
(assert (or (= obligation1ar_12 25)
))
(assert (= obligation1S_12 16))
(assert (= obligation1T_12 20))
(assert (=> (= (obligation1 12) true) (and
 (set.member (tuple  obligation1U_12 obligation1S_12) (ASSIGN* 12))
 (set.member (tuple  obligation1U_12 obligation1UA_12) (ASSIGN* 12))
 (set.member (tuple obligation1UA_12 obligation1ar_12 obligation1AT_12) (ASSOC 12))
 (set.member (tuple  obligation1UO_12 obligation1T_12) (ASSIGN* 12))
 (set.member (tuple  obligation1UO_12 obligation1AT_12) (ASSIGN* 12))
 (set.member (tuple  obligation1U_12 obligation1U_12) USERS)
 (distinct obligation1S_12 obligation1U_12)
)))
...
(declare-fun obligation0_AssignAction_13_0 () (Set (Tuple Int Int)))

(declare-fun obligation0_AssignAction_13_0_* () (Set (Tuple Int Int)))

(assert (=> (= ( obligation0 12) true)
(and

	;INDEPENDENT ACTIONS
	(and

		;ACTION: obligation0_AssignAction_13_0
		(=>(and(not (set.member (tuple 17 16) (ASSIGN 12)))(not (= 17 16))(not (set.member (tuple 16 17) (ASSIGN* 12)))) (and (= obligation0_AssignAction_13_0 (set.singleton( tuple 17 16))) (= obligation0_AssignAction_13_0_* (set.union (set.singleton (tuple 17 16)) (rel.join (set.singleton (tuple 17 16)) (rel.join (set.singleton (tuple 16 16)) (ASSIGN* 12)))))))

		(=>(not (and(not (set.member (tuple 17 16) (ASSIGN 12)))(not (= 17 16))(not (set.member (tuple 16 17) (ASSIGN* 12))))) (and (= obligation0_AssignAction_13_0 (as set.empty (Set (Tuple Int Int)))) (= obligation0_AssignAction_13_0_* (as set.empty (Set (Tuple Int Int))))))

	)
)
)
)(assert (=> (= ( obligation0 12) false) (and(= obligation0_AssignAction_13_0 (as set.empty (Set (Tuple Int Int))))(= obligation0_AssignAction_13_0_* (as set.empty (Set (Tuple Int Int)))))))



(declare-fun obligation1_AssignAction_13_0 () (Set (Tuple Int Int)))

(declare-fun obligation1_AssignAction_13_1 () (Set (Tuple Int Int)))

(declare-fun obligation1_AssignAction_13_0_* () (Set (Tuple Int Int)))

(declare-fun obligation1_AssignAction_13_1_* () (Set (Tuple Int Int)))

(assert (=> (= ( obligation1 12) true)
(and


(or
	(and
	;NEGATED PRECONDITION: obligation1_AssignAction_13_1
	(not 	(and
		(and 
			(not (set.member (tuple 15 18) (ASSIGN 12))) 
			(not (set.subset (set.singleton(tuple 15 18)) (set.union (set.singleton (tuple 15 18)) (rel.join (set.singleton (tuple 15 18)) (rel.join (set.singleton (tuple 18 18)) (ASSIGN* 12)))) )		)
		)
		(and 
			(not (set.member (tuple 18 15) (ASSIGN 12))) 
			(not (set.subset (set.singleton(tuple 18 15)) (set.union (set.singleton (tuple 15 18)) (rel.join (set.singleton (tuple 15 18)) (rel.join (set.singleton (tuple 18 18)) (ASSIGN* 12)))) )		)
		)
	))
	;NEGATED POSTCONDITION: obligation1_AssignAction_13_1
	(= obligation1_AssignAction_13_1 (as set.empty (Set (Tuple Int Int))))
	)

	(and
	;PRECONDITION: obligation1_AssignAction_13_1
	(and
		(and 
			(not (set.member (tuple 15 18) (ASSIGN 12))) 
			(not (set.subset (set.singleton(tuple 15 18)) (set.union (set.singleton (tuple 15 18)) (rel.join (set.singleton (tuple 15 18)) (rel.join (set.singleton (tuple 18 18)) (ASSIGN* 12)))) )		)
	...
	;POSTCONDITION: obligation1_AssignAction_13_1
	(= obligation1_AssignAction_13_1 (set.singleton( tuple 15 18)))
	)
)
	...
	(and
		...
		;ACTION: obligation1_AssignAction_13_0
		(=>(and(not (set.member (tuple 15 18) (ASSIGN 12)))(not (= 15 18))(not (set.member (tuple 18 15) (ASSIGN* 12)))) (and (= obligation1_AssignAction_13_0 (set.singleton( tuple 15 18))) (= obligation1_AssignAction_13_0_* (set.union (set.singleton (tuple 15 18)) (rel.join (set.singleton (tuple 15 18)) (rel.join (set.singleton (tuple 18 18)) (ASSIGN* 12)))))))

		(=>(not (and(not (set.member (tuple 15 18) (ASSIGN 12)))(not (= 15 18))(not (set.member (tuple 18 15) (ASSIGN* 12))))) (and (= obligation1_AssignAction_13_0 (as set.empty (Set (Tuple Int Int)))) (= obligation1_AssignAction_13_0_* (as set.empty (Set (Tuple Int Int))))))

	)
)
)
)(assert (=> (= ( obligation1 12) false) (and(= obligation1_AssignAction_13_0 (as set.empty (Set (Tuple Int Int))))(= obligation1_AssignAction_13_1 (as set.empty (Set (Tuple Int Int))))(= obligation1_AssignAction_13_0_* (as set.empty (Set (Tuple Int Int))))(= obligation1_AssignAction_13_1_* (as set.empty (Set (Tuple Int Int)))))))



;RELATION TRANSITION ENCODING
(assert (= (ASSIGN 13) 
	(set.union (ASSIGN 12) (set.union obligation1_AssignAction_13_1 (set.union obligation1_AssignAction_13_0  obligation0_AssignAction_13_0)))
))
(assert (= (ASSIGN* 13) 
	(set.union (ASSIGN* 12) (set.union obligation1_AssignAction_13_1_* (set.union obligation1_AssignAction_13_0_*  obligation0_AssignAction_13_0_*)))
))
(assert (= (ASSOC 13) (ASSOC 12)))

; 5.3 change implies the execution
(assert (=> (distinct (ASSIGN* 13) (ASSIGN* 12))
(or 
(= (obligation0 12) true)(= (obligation1 12) true))))
(assert (=> (distinct (ASSIGN 13) (ASSIGN 12))
(or (= (obligation0 12) true)(= (obligation1 12) true))))
...
; 5.4 Exactly one naive
; AT LEAST ONE
(assert (or(= (obligation1 12) true)(= (obligation0 12) true)))
...
; 5.1 a->PRE
(declare-fun obligation0U_13 () Int)
(declare-fun obligation0UA_13 () Int)
(declare-fun obligation0AT_13 () Int)
(declare-fun obligation0UO_13 () Int)
(declare-fun obligation0ar_13 () Int)
(declare-fun obligation0S_13 () Int)
(declare-fun obligation0T_13 () Int)
(assert (>= obligation0U_13 0))
(assert (>= obligation0UA_13 0))
(assert (>= obligation0AT_13 0))
(assert (>= obligation0UO_13 0))
(assert (or (= obligation0ar_13 27)
))
(assert (= obligation0S_13 19))
(assert (= obligation0T_13 20))
(assert (=> (= (obligation0 13) true) (and
 (set.member (tuple  obligation0U_13 obligation0S_13) (ASSIGN* 13))
 (set.member (tuple  obligation0U_13 obligation0UA_13) (ASSIGN* 13))
 (set.member (tuple obligation0UA_13 obligation0ar_13 obligation0AT_13) (ASSOC 13))
 (set.member (tuple  obligation0UO_13 obligation0T_13) (ASSIGN* 13))
 (set.member (tuple  obligation0UO_13 obligation0AT_13) (ASSIGN* 13))
 (set.member (tuple  obligation0U_13 obligation0U_13) USERS)
 (distinct obligation0S_13 obligation0U_13)
)))


(declare-fun obligation1U_13 () Int)
(declare-fun obligation1UA_13 () Int)
(declare-fun obligation1AT_13 () Int)
(declare-fun obligation1UO_13 () Int)
(declare-fun obligation1ar_13 () Int)
(declare-fun obligation1S_13 () Int)
(declare-fun obligation1T_13 () Int)
(assert (>= obligation1U_13 0))
(assert (>= obligation1UA_13 0))
(assert (>= obligation1AT_13 0))
(assert (>= obligation1UO_13 0))
(assert (or (= obligation1ar_13 25)
))
(assert (= obligation1S_13 16))
(assert (= obligation1T_13 20))
(assert (=> (= (obligation1 13) true) (and
 (set.member (tuple  obligation1U_13 obligation1S_13) (ASSIGN* 13))
 (set.member (tuple  obligation1U_13 obligation1UA_13) (ASSIGN* 13))
 (set.member (tuple obligation1UA_13 obligation1ar_13 obligation1AT_13) (ASSOC 13))
 (set.member (tuple  obligation1UO_13 obligation1T_13) (ASSIGN* 13))
 (set.member (tuple  obligation1UO_13 obligation1AT_13) (ASSIGN* 13))
 (set.member (tuple  obligation1U_13 obligation1U_13) USERS)
 (distinct obligation1S_13 obligation1U_13)
)))
...
(declare-fun obligation0_AssignAction_14_0 () (Set (Tuple Int Int)))

(declare-fun obligation0_AssignAction_14_0_* () (Set (Tuple Int Int)))

(assert (=> (= ( obligation0 13) true)
(and

	;INDEPENDENT ACTIONS
	(and

		;ACTION: obligation0_AssignAction_14_0
		(=>(and(not (set.member (tuple 17 16) (ASSIGN 13)))(not (= 17 16))(not (set.member (tuple 16 17) (ASSIGN* 13)))) (and (= obligation0_AssignAction_14_0 (set.singleton( tuple 17 16))) (= obligation0_AssignAction_14_0_* (set.union (set.singleton (tuple 17 16)) (rel.join (set.singleton (tuple 17 16)) (rel.join (set.singleton (tuple 16 16)) (ASSIGN* 13)))))))

		(=>(not (and(not (set.member (tuple 17 16) (ASSIGN 13)))(not (= 17 16))(not (set.member (tuple 16 17) (ASSIGN* 13))))) (and (= obligation0_AssignAction_14_0 (as set.empty (Set (Tuple Int Int)))) (= obligation0_AssignAction_14_0_* (as set.empty (Set (Tuple Int Int))))))

	)
)
)
)(assert (=> (= ( obligation0 13) false) (and(= obligation0_AssignAction_14_0 (as set.empty (Set (Tuple Int Int))))(= obligation0_AssignAction_14_0_* (as set.empty (Set (Tuple Int Int)))))))



(declare-fun obligation1_AssignAction_14_0 () (Set (Tuple Int Int)))

(declare-fun obligation1_AssignAction_14_1 () (Set (Tuple Int Int)))

(declare-fun obligation1_AssignAction_14_0_* () (Set (Tuple Int Int)))

(declare-fun obligation1_AssignAction_14_1_* () (Set (Tuple Int Int)))

(assert (=> (= ( obligation1 13) true)
(and


(or
	(and
	;NEGATED PRECONDITION: obligation1_AssignAction_14_1
	(not 	(and
		(and 
			(not (set.member (tuple 15 18) (ASSIGN 13))) 
			(not (set.subset (set.singleton(tuple 15 18)) (set.union (set.singleton (tuple 15 18)) (rel.join (set.singleton (tuple 15 18)) (rel.join (set.singleton (tuple 18 18)) (ASSIGN* 13)))) )		)
		)
		(and 
			(not (set.member (tuple 18 15) (ASSIGN 13))) 
			(not (set.subset (set.singleton(tuple 18 15)) (set.union (set.singleton (tuple 15 18)) (rel.join (set.singleton (tuple 15 18)) (rel.join (set.singleton (tuple 18 18)) (ASSIGN* 13)))) )		)
		)
	))
	;NEGATED POSTCONDITION: obligation1_AssignAction_14_1
	(= obligation1_AssignAction_14_1 (as set.empty (Set (Tuple Int Int))))
	)

	(and
	;PRECONDITION: obligation1_AssignAction_14_1
	(and
		(and 
			(not (set.member (tuple 15 18) (ASSIGN 13))) 
			(not (set.subset (set.singleton(tuple 15 18)) (set.union (set.singleton (tuple 15 18)) (rel.join (set.singleton (tuple 15 18)) (rel.join (set.singleton (tuple 18 18)) (ASSIGN* 13)))) )		)
	...
	;POSTCONDITION: obligation1_AssignAction_14_1
	(= obligation1_AssignAction_14_1 (set.singleton( tuple 15 18)))
	)
)
	...
	(and
		...
		;ACTION: obligation1_AssignAction_14_0
		(=>(and(not (set.member (tuple 15 18) (ASSIGN 13)))(not (= 15 18))(not (set.member (tuple 18 15) (ASSIGN* 13)))) (and (= obligation1_AssignAction_14_0 (set.singleton( tuple 15 18))) (= obligation1_AssignAction_14_0_* (set.union (set.singleton (tuple 15 18)) (rel.join (set.singleton (tuple 15 18)) (rel.join (set.singleton (tuple 18 18)) (ASSIGN* 13)))))))

		(=>(not (and(not (set.member (tuple 15 18) (ASSIGN 13)))(not (= 15 18))(not (set.member (tuple 18 15) (ASSIGN* 13))))) (and (= obligation1_AssignAction_14_0 (as set.empty (Set (Tuple Int Int)))) (= obligation1_AssignAction_14_0_* (as set.empty (Set (Tuple Int Int))))))

	)
)
)
)(assert (=> (= ( obligation1 13) false) (and(= obligation1_AssignAction_14_0 (as set.empty (Set (Tuple Int Int))))(= obligation1_AssignAction_14_1 (as set.empty (Set (Tuple Int Int))))(= obligation1_AssignAction_14_0_* (as set.empty (Set (Tuple Int Int))))(= obligation1_AssignAction_14_1_* (as set.empty (Set (Tuple Int Int)))))))



;RELATION TRANSITION ENCODING
(assert (= (ASSIGN 14) 
	(set.union (ASSIGN 13) (set.union obligation1_AssignAction_14_1 (set.union obligation1_AssignAction_14_0  obligation0_AssignAction_14_0)))
))
(assert (= (ASSIGN* 14) 
	(set.union (ASSIGN* 13) (set.union obligation1_AssignAction_14_1_* (set.union obligation1_AssignAction_14_0_*  obligation0_AssignAction_14_0_*)))
))
(assert (= (ASSOC 14) (ASSOC 13)))

; 5.3 change implies the execution
(assert (=> (distinct (ASSIGN* 14) (ASSIGN* 13))
(or 
(= (obligation0 13) true)(= (obligation1 13) true))))
(assert (=> (distinct (ASSIGN 14) (ASSIGN 13))
(or (= (obligation0 13) true)(= (obligation1 13) true))))
...
; 5.4 Exactly one naive
; AT LEAST ONE
(assert (or(= (obligation1 13) true)(= (obligation0 13) true)))
...
; 5.1 a->PRE
(declare-fun obligation0U_14 () Int)
(declare-fun obligation0UA_14 () Int)
(declare-fun obligation0AT_14 () Int)
(declare-fun obligation0UO_14 () Int)
(declare-fun obligation0ar_14 () Int)
(declare-fun obligation0S_14 () Int)
(declare-fun obligation0T_14 () Int)
(assert (>= obligation0U_14 0))
(assert (>= obligation0UA_14 0))
(assert (>= obligation0AT_14 0))
(assert (>= obligation0UO_14 0))
(assert (or (= obligation0ar_14 27)
))
(assert (= obligation0S_14 19))
(assert (= obligation0T_14 20))
(assert (=> (= (obligation0 14) true) (and
 (set.member (tuple  obligation0U_14 obligation0S_14) (ASSIGN* 14))
 (set.member (tuple  obligation0U_14 obligation0UA_14) (ASSIGN* 14))
 (set.member (tuple obligation0UA_14 obligation0ar_14 obligation0AT_14) (ASSOC 14))
 (set.member (tuple  obligation0UO_14 obligation0T_14) (ASSIGN* 14))
 (set.member (tuple  obligation0UO_14 obligation0AT_14) (ASSIGN* 14))
 (set.member (tuple  obligation0U_14 obligation0U_14) USERS)
 (distinct obligation0S_14 obligation0U_14)
)))


(declare-fun obligation1U_14 () Int)
(declare-fun obligation1UA_14 () Int)
(declare-fun obligation1AT_14 () Int)
(declare-fun obligation1UO_14 () Int)
(declare-fun obligation1ar_14 () Int)
(declare-fun obligation1S_14 () Int)
(declare-fun obligation1T_14 () Int)
(assert (>= obligation1U_14 0))
(assert (>= obligation1UA_14 0))
(assert (>= obligation1AT_14 0))
(assert (>= obligation1UO_14 0))
(assert (or (= obligation1ar_14 25)
))
(assert (= obligation1S_14 16))
(assert (= obligation1T_14 20))
(assert (=> (= (obligation1 14) true) (and
 (set.member (tuple  obligation1U_14 obligation1S_14) (ASSIGN* 14))
 (set.member (tuple  obligation1U_14 obligation1UA_14) (ASSIGN* 14))
 (set.member (tuple obligation1UA_14 obligation1ar_14 obligation1AT_14) (ASSOC 14))
 (set.member (tuple  obligation1UO_14 obligation1T_14) (ASSIGN* 14))
 (set.member (tuple  obligation1UO_14 obligation1AT_14) (ASSIGN* 14))
 (set.member (tuple  obligation1U_14 obligation1U_14) USERS)
 (distinct obligation1S_14 obligation1U_14)
)))
...
(declare-fun obligation0_AssignAction_15_0 () (Set (Tuple Int Int)))

(declare-fun obligation0_AssignAction_15_0_* () (Set (Tuple Int Int)))

(assert (=> (= ( obligation0 14) true)
(and

	;INDEPENDENT ACTIONS
	(and

		;ACTION: obligation0_AssignAction_15_0
		(=>(and(not (set.member (tuple 17 16) (ASSIGN 14)))(not (= 17 16))(not (set.member (tuple 16 17) (ASSIGN* 14)))) (and (= obligation0_AssignAction_15_0 (set.singleton( tuple 17 16))) (= obligation0_AssignAction_15_0_* (set.union (set.singleton (tuple 17 16)) (rel.join (set.singleton (tuple 17 16)) (rel.join (set.singleton (tuple 16 16)) (ASSIGN* 14)))))))

		(=>(not (and(not (set.member (tuple 17 16) (ASSIGN 14)))(not (= 17 16))(not (set.member (tuple 16 17) (ASSIGN* 14))))) (and (= obligation0_AssignAction_15_0 (as set.empty (Set (Tuple Int Int)))) (= obligation0_AssignAction_15_0_* (as set.empty (Set (Tuple Int Int))))))

	)
)
)
)(assert (=> (= ( obligation0 14) false) (and(= obligation0_AssignAction_15_0 (as set.empty (Set (Tuple Int Int))))(= obligation0_AssignAction_15_0_* (as set.empty (Set (Tuple Int Int)))))))



(declare-fun obligation1_AssignAction_15_0 () (Set (Tuple Int Int)))

(declare-fun obligation1_AssignAction_15_1 () (Set (Tuple Int Int)))

(declare-fun obligation1_AssignAction_15_0_* () (Set (Tuple Int Int)))

(declare-fun obligation1_AssignAction_15_1_* () (Set (Tuple Int Int)))

(assert (=> (= ( obligation1 14) true)
(and


(or
	(and
	;NEGATED PRECONDITION: obligation1_AssignAction_15_1
	(not 	(and
		(and 
			(not (set.member (tuple 15 18) (ASSIGN 14))) 
			(not (set.subset (set.singleton(tuple 15 18)) (set.union (set.singleton (tuple 15 18)) (rel.join (set.singleton (tuple 15 18)) (rel.join (set.singleton (tuple 18 18)) (ASSIGN* 14)))) )		)
		)
		(and 
			(not (set.member (tuple 18 15) (ASSIGN 14))) 
			(not (set.subset (set.singleton(tuple 18 15)) (set.union (set.singleton (tuple 15 18)) (rel.join (set.singleton (tuple 15 18)) (rel.join (set.singleton (tuple 18 18)) (ASSIGN* 14)))) )		)
		)
	))
	;NEGATED POSTCONDITION: obligation1_AssignAction_15_1
	(= obligation1_AssignAction_15_1 (as set.empty (Set (Tuple Int Int))))
	)

	(and
	;PRECONDITION: obligation1_AssignAction_15_1
	(and
		(and 
			(not (set.member (tuple 15 18) (ASSIGN 14))) 
			(not (set.subset (set.singleton(tuple 15 18)) (set.union (set.singleton (tuple 15 18)) (rel.join (set.singleton (tuple 15 18)) (rel.join (set.singleton (tuple 18 18)) (ASSIGN* 14)))) )		)
	...
	;POSTCONDITION: obligation1_AssignAction_15_1
	(= obligation1_AssignAction_15_1 (set.singleton( tuple 15 18)))
	)
)
	...
	(and
		...
		;ACTION: obligation1_AssignAction_15_0
		(=>(and(not (set.member (tuple 15 18) (ASSIGN 14)))(not (= 15 18))(not (set.member (tuple 18 15) (ASSIGN* 14)))) (and (= obligation1_AssignAction_15_0 (set.singleton( tuple 15 18))) (= obligation1_AssignAction_15_0_* (set.union (set.singleton (tuple 15 18)) (rel.join (set.singleton (tuple 15 18)) (rel.join (set.singleton (tuple 18 18)) (ASSIGN* 14)))))))

		(=>(not (and(not (set.member (tuple 15 18) (ASSIGN 14)))(not (= 15 18))(not (set.member (tuple 18 15) (ASSIGN* 14))))) (and (= obligation1_AssignAction_15_0 (as set.empty (Set (Tuple Int Int)))) (= obligation1_AssignAction_15_0_* (as set.empty (Set (Tuple Int Int))))))

	)
)
)
)(assert (=> (= ( obligation1 14) false) (and(= obligation1_AssignAction_15_0 (as set.empty (Set (Tuple Int Int))))(= obligation1_AssignAction_15_1 (as set.empty (Set (Tuple Int Int))))(= obligation1_AssignAction_15_0_* (as set.empty (Set (Tuple Int Int))))(= obligation1_AssignAction_15_1_* (as set.empty (Set (Tuple Int Int)))))))



;RELATION TRANSITION ENCODING
(assert (= (ASSIGN 15) 
	(set.union (ASSIGN 14) (set.union obligation1_AssignAction_15_1 (set.union obligation1_AssignAction_15_0  obligation0_AssignAction_15_0)))
))
(assert (= (ASSIGN* 15) 
	(set.union (ASSIGN* 14) (set.union obligation1_AssignAction_15_1_* (set.union obligation1_AssignAction_15_0_*  obligation0_AssignAction_15_0_*)))
))
(assert (= (ASSOC 15) (ASSOC 14)))

; 5.3 change implies the execution
(assert (=> (distinct (ASSIGN* 15) (ASSIGN* 14))
(or 
(= (obligation0 14) true)(= (obligation1 14) true))))
(assert (=> (distinct (ASSIGN 15) (ASSIGN 14))
(or (= (obligation0 14) true)(= (obligation1 14) true))))
...
; 5.4 Exactly one naive
; AT LEAST ONE
(assert (or(= (obligation1 14) true)(= (obligation0 14) true)))
...
(assert 
(and (= (obligation15 14) true)
 (= obligation15U_14 queryVARu2 ) (= obligation15ar_14 queryVARar2 ) (= obligation15T_14 queryVARat2 )))
(check-sat)
...
(get-value (obligation0UO_12))
(get-value (obligation0S_12))
(get-value (obligation0T_12))
(get-value (obligation0ar_12))
(get-value (obligation1U_12))
(get-value (obligation1UA_12))
(get-value (obligation1AT_12))
(get-value (obligation1UO_12))
(get-value (obligation1S_12))
(get-value (obligation1T_12))
(get-value (obligation1ar_12))
(get-value (obligation0U_0))
(get-value (obligation0UA_0))
(get-value (obligation0AT_0))
(get-value (obligation0UO_0))
...
(get-value (obligation0UO_13))
(get-value (obligation0S_13))
(get-value (obligation0T_13))
(get-value (obligation0ar_13))
(get-value (obligation1U_13))
(get-value (obligation1UA_13))
(get-value (obligation1AT_13))
(get-value (obligation1UO_13))
(get-value (obligation1S_13))
(get-value (obligation1T_13))
(get-value (obligation1ar_13))
(get-value (obligation0U_0))
(get-value (obligation0UA_0))
(get-value (obligation0AT_0))
(get-value (obligation0UO_0))
...
(get-value (obligation0UO_14))
(get-value (obligation0S_14))
(get-value (obligation0T_14))
(get-value (obligation0ar_14))
(get-value (obligation1U_14))
(get-value (obligation1UA_14))
(get-value (obligation1AT_14))
(get-value (obligation1UO_14))
(get-value (obligation1S_14))
(get-value (obligation1T_14))
(get-value (obligation1ar_14))
