...
(and
	...
	(and
		...
		(=>(not (set.member (tuple 14 20 17) (ASSOC 3))) (= create_proposal_GrantAction_4_0 (set.singleton(tuple 14 20 17))))

		(=>(not 
(not (set.member (tuple 14 20 17) (ASSOC 3)))	) (= create_proposal_GrantAction_4_0 (as set.empty (Set (Tuple Int Int Int)))))
...
(declare-fun add_copi_AssignAction_4_1 () (Set (Tuple Int Int)))
...
(declare-fun add_copi_AssignAction_4_1_* () (Set (Tuple Int Int)))
...
(and
	...
	(and
		...
		(=>(not 
(and(not (set.member (tuple ?chair_customvar_4 2) (ASSIGN 3)))(not (= ?chair_customvar_4 2))(not (set.member (tuple 2 ?chair_customvar_4) (ASSIGN* 3))))	) (and (= add_copi_AssignAction_4_0 (as set.empty (Set (Tuple Int Int)))) (= add_copi_AssignAction_4_0_* (as set.empty (Set (Tuple Int Int))))))

		;ACTION: add_copi_AssignAction_4_1
		(=>(and(not (set.member (tuple 5 3) (ASSIGN 3)))(not (= 5 3))(not (set.member (tuple 3 5) (ASSIGN* 3)))) (and (= add_copi_AssignAction_4_1 (set.singleton( tuple 5 3))) (= add_copi_AssignAction_4_1_* (set.union (set.singleton (tuple 5 3)) (rel.join (set.singleton (tuple 5 3)) (rel.join (set.singleton (tuple 3 3)) (ASSIGN* 3)))))))

		(=>(not 
(and(not (set.member (tuple 5 3) (ASSIGN 3)))(not (= 5 3))(not (set.member (tuple 3 5) (ASSIGN* 3))))	) (and (= add_copi_AssignAction_4_1 (as set.empty (Set (Tuple Int Int)))) (= add_copi_AssignAction_4_1_* (as set.empty (Set (Tuple Int Int))))))
		...
		(=>(not 
(and(not (set.member (tuple ?bm_customvar_4 6) (ASSIGN 3)))(not (= ?bm_customvar_4 6))(not (set.member (tuple 6 ?bm_customvar_4) (ASSIGN* 3))))	) (and (= add_copi_AssignAction_4_2 (as set.empty (Set (Tuple Int Int)))) (= add_copi_AssignAction_4_2_* (as set.empty (Set (Tuple Int Int))))))
...
)(assert (=> (= ( add_copi 3) false) (and(= add_copi_AssignAction_4_0 (as set.empty (Set (Tuple Int Int))))(= add_copi_AssignAction_4_1 (as set.empty (Set (Tuple Int Int))))(= add_copi_AssignAction_4_2 (as set.empty (Set (Tuple Int Int))))(= add_copi_AssignAction_4_3 (as set.empty (Set (Tuple Int Int))))(= add_copi_AssignAction_4_0_* (as set.empty (Set (Tuple Int Int))))(= add_copi_AssignAction_4_1_* (as set.empty (Set (Tuple Int Int))))(= add_copi_AssignAction_4_2_* (as set.empty (Set (Tuple Int Int))))(= add_copi_AssignAction_4_3_* (as set.empty (Set (Tuple Int Int)))))))



;RELATION TRANSITION ENCODING
(assert (= (ASSIGN 4) 
	(set.union (ASSIGN 3) (set.union add_copi_AssignAction_4_3 (set.union add_copi_AssignAction_4_2 (set.union add_copi_AssignAction_4_1  add_copi_AssignAction_4_0))))
))
(assert (= (ASSIGN* 4) 
	(set.union (ASSIGN* 3) (set.union add_copi_AssignAction_4_3_* (set.union add_copi_AssignAction_4_2_* (set.union add_copi_AssignAction_4_1_*  add_copi_AssignAction_4_0_*))))
))
(assert (= (ASSOC 4) 
	(set.union (ASSOC 3)  create_proposal_GrantAction_4_0)
))
...
(or 
(= (create_proposal 3) true)(= (add_copi 3) true))))


; 5.4 Exactly one naive
; AT LEAST ONE
(assert (or(= (create_proposal 3) true)(= (add_copi 3) true)))
...
(assert 
(and (= (create 3) true)
 (= createU_3 queryVARu ) (= createar_3 queryVARar ) (= createT_3 queryVARat )))
(check-sat)
