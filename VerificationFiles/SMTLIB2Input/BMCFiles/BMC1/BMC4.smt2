...
(xor 
(= (create_proposal 0) 0) 
(and (member (mkTuple 17 95 31) (ASSOC* 0))  (member (mkTuple 77 17) (ASSIGN* 0)) (= (create_proposal 0) 1))
)
)				
...
(xor 
(= (create_proposal 1) 0) 
(and (member (mkTuple 17 95 31) (ASSOC* 1))  (member (mkTuple 77 17) (ASSIGN* 1)) (= (create_proposal 1) 1))
)
)				
...
(xor 
(= (create_proposal 2) 0) 
(and (member (mkTuple 17 95 31) (ASSOC* 2))  (member (mkTuple 77 17) (ASSIGN* 2)) (= (create_proposal 2) 1))
)
)				
...
(xor 
(= (create_proposal 3) 0) 
(and (member (mkTuple 17 95 31) (ASSOC* 3))  (member (mkTuple 77 17) (ASSIGN* 3)) (= (create_proposal 3) 1))
)
)				
