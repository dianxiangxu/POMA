...
(or 
(= (obligation3 0) true)(= (obligation2 0) true)(= (obligation5 0) true)(= (obligation4 0) true))))
(assert (=> (distinct (ASSIGN 1) (ASSIGN 0))
(or (= (obligation3 0) true)(= (obligation2 0) true)(= (obligation5 0) true)(= (obligation4 0) true))))
...
; AT LEAST ONE
(assert (or(= (obligation3 0) true)(= (obligation2 0) true)(= (obligation5 0) true)(= (obligation4 0) true)))
...
(or 
(= (obligation3 1) true)(= (obligation2 1) true)(= (obligation5 1) true)(= (obligation4 1) true))))
(assert (=> (distinct (ASSIGN 2) (ASSIGN 1))
(or (= (obligation3 1) true)(= (obligation2 1) true)(= (obligation5 1) true)(= (obligation4 1) true))))
...
; AT LEAST ONE
(assert (or(= (obligation3 1) true)(= (obligation2 1) true)(= (obligation5 1) true)(= (obligation4 1) true)))
...
(or 
(= (obligation3 2) true)(= (obligation2 2) true)(= (obligation5 2) true)(= (obligation4 2) true))))
(assert (=> (distinct (ASSIGN 3) (ASSIGN 2))
(or (= (obligation3 2) true)(= (obligation2 2) true)(= (obligation5 2) true)(= (obligation4 2) true))))
...
; AT LEAST ONE
(assert (or(= (obligation3 2) true)(= (obligation2 2) true)(= (obligation5 2) true)(= (obligation4 2) true)))
...
(assert (or (= obligation4ar_3 14)
))
(assert (= obligation4S_3 2))
...
(assert (or (= obligation5ar_3 14)
))
(assert (= obligation5S_3 8))
...
(assert (=> (= (obligation2 3) true)(= (ASSIGN* 4) (union (join (join (union (singleton (mkTuple 6 6)) (join (ASSIGN* 3) (singleton (mkTuple 6 6)))) (singleton (mkTuple 6 4))) (union (singleton (mkTuple 4 4)) (join (singleton (mkTuple 4 4)) (ASSIGN* 3) ))) (ASSIGN* 3)))))
(assert (=> (= (obligation2 3) true)(= (ASSIGN 4)( union (ASSIGN 3) (singleton (mkTuple 6 4))))))
...
(assert (=> (= (obligation3 3) true)(= (ASSIGN* 4) (union (join (join (union (singleton (mkTuple 2 2)) (join (ASSIGN* 3) (singleton (mkTuple 2 2)))) (singleton (mkTuple 2 6))) (union (singleton (mkTuple 6 6)) (join (singleton (mkTuple 6 6)) (ASSIGN* 3) ))) (ASSIGN* 3)))))
(assert (=> (= (obligation3 3) true)(= (ASSIGN 4)( union (ASSIGN 3) (singleton (mkTuple 2 6))))))
...
(assert (=> (=(obligation4 3) true) (= (ASSIGN 4) (ASSIGN 3))))
(assert (=> (= (obligation4 3) true)(= (ASSOC 4) (union(ASSOC 3)(singleton(mkTuple 7 15 9))))))




(assert (=> (= (obligation5 3) true)(= (ASSIGN* 4)(setminus (ASSIGN* 3) (setminus (setminus (union (singleton (mkTuple 6 8)) (join (singleton (mkTuple 6 8)) (ASSIGN* 3))) (join (join (intersection (join (union  (singleton (mkTuple 6 6)) (join (ASSIGN* 3)  (singleton (mkTuple 6 6)))) (transpose (union  (singleton (mkTuple 6 6)) (join (ASSIGN* 3)  (singleton (mkTuple 6 6)))))) NODES) (setminus (ASSIGN 3) (singleton (mkTuple 6 8)))) (ASSIGN* 3))) (join (join (intersection (join (union  (singleton (mkTuple 6 6)) (join (ASSIGN* 3)  (singleton (mkTuple 6 6)))) (transpose (union  (singleton (mkTuple 6 6)) (join (ASSIGN* 3)  (singleton (mkTuple 6 6)))))) NODES) (setminus (ASSIGN 3) (singleton (mkTuple 6 8)))) (ASSIGN* 3)))))))
(assert (=> (= (obligation5 3) true)(= (ASSIGN 4) (setminus (ASSIGN 3) (singleton (mkTuple 6 8))))))
...
(or 
(= (obligation3 3) true)(= (obligation2 3) true)(= (obligation5 3) true)(= (obligation4 3) true))))
(assert (=> (distinct (ASSIGN 4) (ASSIGN 3))
(or (= (obligation3 3) true)(= (obligation2 3) true)(= (obligation5 3) true)(= (obligation4 3) true))))
...
; AT LEAST ONE
(assert (or(= (obligation3 3) true)(= (obligation2 3) true)(= (obligation5 3) true)(= (obligation4 3) true)))


(declare-fun queryVARPERMITUA_Attorneys_?ar_?at_4 () Int)
(declare-fun queryVARPERMITAR_Attorneys_?ar_?at_4 () Int)
(declare-fun queryVARPERMITAT_Attorneys_?ar_?at_4 () Int)
(declare-fun queryVARPERMITUO_Attorneys_?ar_?at_4 () Int)
(declare-fun queryVARPERMITUA_Attorneys1_?ar_?at_4 () Int)
(declare-fun queryVARPERMITAR_Attorneys1_?ar_?at_4 () Int)
(declare-fun queryVARPERMITAT_Attorneys1_?ar_?at_4 () Int)
(declare-fun queryVARPERMITUO_Attorneys1_?ar_?at_4 () Int)
(assert (and (and 
(member (mkTuple  4  8 ) (ASSIGN 4))
 (not 
(and(member (mkTuple  8  queryVARPERMITUA_Attorneys_?ar_?at_4 ) (ASSIGN* 4))(member (mkTuple  queryVARPERMITUA_Attorneys_?ar_?at_4  queryVARPERMITAR_Attorneys_?ar_?at_4  queryVARPERMITAT_Attorneys_?ar_?at_4 ) (ASSOC 4))(member (mkTuple   queryVARPERMITUO_Attorneys_?ar_?at_4  queryVARPERMITAT_Attorneys_?ar_?at_4 ) (ASSIGN* 4)))
)) (not 
(and(member (mkTuple  4  queryVARPERMITUA_Attorneys1_?ar_?at_4 ) (ASSIGN* 4))(member (mkTuple  queryVARPERMITUA_Attorneys1_?ar_?at_4  queryVARPERMITAR_Attorneys1_?ar_?at_4  queryVARPERMITAT_Attorneys1_?ar_?at_4 ) (ASSOC 4))(member (mkTuple   queryVARPERMITUO_Attorneys1_?ar_?at_4  queryVARPERMITAT_Attorneys1_?ar_?at_4 ) (ASSIGN* 4)))
)))
...
(declare-fun queryVARASSIGN*D_Attorneys1_2 () Int)
(declare-fun queryVARASSIGN*D_Attorneys_2 () Int)
(declare-fun queryVARPERMITUA_Attorneys_?ar_?at_3 () Int)
(declare-fun queryVARPERMITAR_Attorneys_?ar_?at_3 () Int)
(declare-fun queryVARPERMITAT_Attorneys_?ar_?at_3 () Int)
(declare-fun queryVARPERMITUO_Attorneys_?ar_?at_3 () Int)
(declare-fun queryVARPERMITUA_Attorneys1_?ar_?at_3 () Int)
(declare-fun queryVARPERMITAR_Attorneys1_?ar_?at_3 () Int)
(declare-fun queryVARPERMITAT_Attorneys1_?ar_?at_3 () Int)
(declare-fun queryVARPERMITUO_Attorneys1_?ar_?at_3 () Int)
(assert (and (and (and (and (and (and 
(and(member (mkTuple  8  queryVARPERMITUA_Attorneys_accept_Case3Info_3 ) (ASSIGN* 3))(member (mkTuple  queryVARPERMITUA_Attorneys_accept_Case3Info_3 14  queryVARPERMITAT_Attorneys_accept_Case3Info_3 ) (ASSOC 3))(member (mkTuple  1  queryVARPERMITAT_Attorneys_accept_Case3Info_3 ) (ASSIGN* 3)))
 
(member (mkTuple  4  queryVARASSIGN*D_Attorneys1_2 ) (ASSIGN* 3))
) 
(member (mkTuple  8  queryVARASSIGN*D_Attorneys_2 ) (ASSIGN* 3))
) (not 
(member (mkTuple  4  8 ) (ASSIGN 3))
)) 
(and(member (mkTuple  8  queryVARPERMITUA_Attorneys_?ar_?at_3 ) (ASSIGN* 3))(member (mkTuple  queryVARPERMITUA_Attorneys_?ar_?at_3  queryVARPERMITAR_Attorneys_?ar_?at_3  queryVARPERMITAT_Attorneys_?ar_?at_3 ) (ASSOC 3))(member (mkTuple   queryVARPERMITUO_Attorneys_?ar_?at_3  queryVARPERMITAT_Attorneys_?ar_?at_3 ) (ASSIGN* 3)))
) (not 
(and(member (mkTuple  4  queryVARPERMITUA_Attorneys1_?ar_?at_3 ) (ASSIGN* 3))(member (mkTuple  queryVARPERMITUA_Attorneys1_?ar_?at_3  queryVARPERMITAR_Attorneys1_?ar_?at_3  queryVARPERMITAT_Attorneys1_?ar_?at_3 ) (ASSOC 3))(member (mkTuple   queryVARPERMITUO_Attorneys1_?ar_?at_3  queryVARPERMITAT_Attorneys1_?ar_?at_3 ) (ASSIGN* 3)))
)) 
