...
;QUERY
(declare-fun query1U3 () Int)(declare-fun query1UO3 () Int)(declare-fun query1UA3 () Int)(declare-fun query1AT3 () Int)(declare-fun query1ar3 () Int)(assert (= query1ar3 null))
(assert (not (let( (.def_U query1U3)(.def_UA query1UA3) (.def_UO query1UO3) (.def_AT query1AT3) (.def_AT query1AT3))(and(member (mkTuple  .def_U .def_UA) (ASSIGN* 4))(member (mkTuple .def_UA query1ar3 .def_AT) (ASSOC 4))(member (mkTuple  9 .def_AT) (ASSIGN* 4))))))
