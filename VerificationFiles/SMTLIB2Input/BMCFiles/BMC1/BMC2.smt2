...
(and
	...
	(and
		...
		(=>(and(not (set.member (tuple 1 7) (ASSIGN 0)))(not (= 1 7))(not (set.member (tuple 7 1) (ASSIGN* 0)))) (= obligation1_AssignAction_1_0 (set.singleton( tuple 1 7))))

		(=>(not (and(not (set.member (tuple 1 7) (ASSIGN 0)))(not (= 1 7))(not (set.member (tuple 7 1) (ASSIGN* 0))))) (= obligation1_AssignAction_1_0 (as set.empty (Set (Tuple Int Int)))))
...
(and
	...
	(and
		...
		(=>(and(not (set.member (tuple 1 7) (ASSIGN 1)))(not (= 1 7))(not (set.member (tuple 7 1) (ASSIGN* 1)))) (= obligation1_AssignAction_2_0 (set.singleton( tuple 1 7))))

		(=>(not (and(not (set.member (tuple 1 7) (ASSIGN 1)))(not (= 1 7))(not (set.member (tuple 7 1) (ASSIGN* 1))))) (= obligation1_AssignAction_2_0 (as set.empty (Set (Tuple Int Int)))))
