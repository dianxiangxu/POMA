...
(assert 
(and (= (remove_available_attorney 1) true)
 (= remove_available_attorneyU_1 queryVARu ) (= remove_available_attorneyar_1 queryVARar ) (= remove_available_attorneyT_1 queryVARat )))
(check-sat)
