...
(and (= (obligation1 0) true)
 (= obligation1U_0 queryVARuser ) (= obligation1ar_0 queryVARar ) (= obligation1T_0 queryVARo )))

;POST PROPERTY
(declare-fun queryCONSTDENYUA_Attorneys2U_accept_Case3Info_1 () Int)
(declare-fun queryCONSTDENYAT_Attorneys2U_accept_Case3Info_1 () Int)
(assert (and 
(and (= (obligation3 1) true)
 (= obligation3U_1 queryVARuser ) (= obligation3ar_1 queryVARar ) (= obligation3T_1 1 )) 
(and(member (mkTuple  12  queryCONSTDENYUA_Attorneys2U_accept_Case3Info_1 ) (ASSIGN* 2))(member (mkTuple  queryCONSTDENYUA_Attorneys2U_accept_Case3Info_1 19  queryCONSTDENYAT_Attorneys2U_accept_Case3Info_1 ) (ASSOC 2))(member (mkTuple  1  queryCONSTDENYAT_Attorneys2U_accept_Case3Info_1 ) (ASSIGN* 2)))
))
(check-sat)
