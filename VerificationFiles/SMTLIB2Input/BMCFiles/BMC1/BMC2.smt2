...
(and (= (obligation3 0) true)
 (= obligation3U_0 queryVARuser1 ) (= obligation3ar_0 queryVARar ) (= obligation3T_0 queryVARo )))

;POST PROPERTY
(declare-fun queryVARuser2 () Int)
(assert 
(and (= (obligation5 1) true)
 (= obligation5U_1 queryVARuser2 ) (= obligation5ar_1 queryVARar ) (= obligation5T_1 queryVARo )))
(check-sat)
