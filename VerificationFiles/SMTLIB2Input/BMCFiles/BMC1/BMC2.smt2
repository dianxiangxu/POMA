...
(and (= (obligation5 0) true)
 (= obligation5U_0 queryVARuser1 ) (= obligation5ar_0 queryVARar ) (= obligation5T_0 queryVARo )))

;POST PROPERTY
(declare-fun queryVARuser2 () Int)
(assert 
(and (= (obligation4 1) true)
 (= obligation4U_1 queryVARuser2 ) (= obligation4ar_1 queryVARar ) (= obligation4T_1 queryVARo )))
(check-sat)
