...
(declare-fun queryVARPERMITUA_PI_submit_PDSWhole_1 () Int)
(declare-fun queryVARPERMITAT_PI_submit_PDSWhole_1 () Int)
(assert (and (and 
(and (= (obligation1 1) true)
 (= obligation1S_1 14 ) (= obligation1ar_1 27 ) (= obligation1T_1 15 )) 
(and(member (mkTuple  14  queryVARPERMITUA_PI_submit_PDSWhole_1 ) (ASSIGN* 1))(member (mkTuple  queryVARPERMITUA_PI_submit_PDSWhole_1 27  queryVARPERMITAT_PI_submit_PDSWhole_1 ) (ASSOC 1))(member (mkTuple  15  queryVARPERMITAT_PI_submit_PDSWhole_1 ) (ASSIGN* 1)))
) 
(member (mkTuple  14  27  15 ) (ASSOC 1))
))
(check-sat)
