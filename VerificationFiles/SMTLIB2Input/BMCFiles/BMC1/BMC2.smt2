...
(and
	...
	(and
		...
		(=>(not 
(and (not (set.member (tuple 14 21 17) (ASSOC 0)))(not (set.member (tuple 14 20 17) (ASSOC 0))))	) (= create_proposal_GrantAction_1_0 (as set.empty (Set (Tuple Int Int Int)))))
...
(and (set.member (tuple ?dean_customvar_1  7  ) (ASSIGN 0)) (distinct ?dean_customvar_1  7 ))
		...
		(=>(and (not 
(and (set.member (tuple ?dean_customvar_1  7  ) (ASSIGN 0)) (distinct ?dean_customvar_1  7 ))
)(not (set.member (tuple 14 20 ?test_customvar_1) (ASSOC 0)))) (= add_copi_GrantAction_1_4 (set.singleton(tuple 14 20 ?test_customvar_1))))

		(=>(not 
(and (not 
(and (set.member (tuple ?dean_customvar_1  7  ) (ASSIGN 0)) (distinct ?dean_customvar_1  7 ))
)(not (set.member (tuple 14 20 ?test_customvar_1) (ASSOC 0))))	) (= add_copi_GrantAction_1_4 (as set.empty (Set (Tuple Int Int Int)))))
...
(and
	...
	(and
		...
		(=>(not 
(and (not (set.member (tuple 14 21 17) (ASSOC 1)))(not (set.member (tuple 14 20 17) (ASSOC 1))))	) (= create_proposal_GrantAction_2_0 (as set.empty (Set (Tuple Int Int Int)))))
...
(and (set.member (tuple ?dean_customvar_2  7  ) (ASSIGN 1)) (distinct ?dean_customvar_2  7 ))
		...
		(=>(and (not 
(and (set.member (tuple ?dean_customvar_2  7  ) (ASSIGN 1)) (distinct ?dean_customvar_2  7 ))
)(not (set.member (tuple 14 20 ?test_customvar_2) (ASSOC 1)))) (= add_copi_GrantAction_2_4 (set.singleton(tuple 14 20 ?test_customvar_2))))

		(=>(not 
(and (not 
(and (set.member (tuple ?dean_customvar_2  7  ) (ASSIGN 1)) (distinct ?dean_customvar_2  7 ))
)(not (set.member (tuple 14 20 ?test_customvar_2) (ASSOC 1))))	) (= add_copi_GrantAction_2_4 (as set.empty (Set (Tuple Int Int Int)))))
