...
(assert 
(xor 
(= (accept_refuse_case_A 12) 0) 
(and (member (mkTuple 7 19 3) (AccessRights 12)) (= (accept_refuse_case_A 12) 1))
)
)				
(assert 
(xor 
(= (withdraw_case_info 12) 0) 
(and (member (mkTuple 10 15 3) (AccessRights 12)) (= (withdraw_case_info 12) 1))
)
)				
(assert 
(xor 
(= (accept_case_Final 12) 0) 
(and (member (mkTuple 7 19 3) (AccessRights 12)) (= (accept_case_Final 12) 1))
)
)				
(assert 
(xor 
(= (approve_case 12) 0) 
(and (member (mkTuple 2 20 3) (AccessRights 12)) (= (approve_case 12) 1))
)
)				
...
(assert (or 
(and (= (accept_refuse_case_A 12) 1)
(xor (= (Associations 13) 
(setminus (union  (Associations 12) (singleton(mkTuple 6 19 3))) (singleton(mkTuple 7 20 13))))
(= (Associations 13) (Associations 12))))

(and (= (withdraw_case_info 12) 1)
(xor (= (Associations 13) 
(union  (Associations 12) (singleton(mkTuple 7 19 13))))
(= (Associations 13) (Associations 12))))

(and (= (accept_case_Final 12) 1)
(xor (= (Associations 13) 
(union  (Associations 12) (singleton(mkTuple 2 20 13))))
(= (Associations 13) (Associations 12))))

(and (= (approve_case 12) 1)
(xor (= (Associations 13) 
(setminus  (Associations 12) (singleton(mkTuple 2 20 13))))
(= (Associations 13) (Associations 12))))
...
(assert 
(xor 
(= (accept_refuse_case_A 13) 0) 
(and (member (mkTuple 7 19 3) (AccessRights 13)) (= (accept_refuse_case_A 13) 1))
)
)				
(assert 
(xor 
(= (withdraw_case_info 13) 0) 
(and (member (mkTuple 10 15 3) (AccessRights 13)) (= (withdraw_case_info 13) 1))
)
)				
(assert 
(xor 
(= (accept_case_Final 13) 0) 
(and (member (mkTuple 7 19 3) (AccessRights 13)) (= (accept_case_Final 13) 1))
)
)				
(assert 
(xor 
(= (approve_case 13) 0) 
(and (member (mkTuple 2 20 3) (AccessRights 13)) (= (approve_case 13) 1))
)
)				
...
(assert (or 
(and (= (accept_refuse_case_A 13) 1)
(xor (= (Associations 14) 
(setminus (union  (Associations 13) (singleton(mkTuple 6 19 3))) (singleton(mkTuple 7 20 13))))
(= (Associations 14) (Associations 13))))

(and (= (withdraw_case_info 13) 1)
(xor (= (Associations 14) 
(union  (Associations 13) (singleton(mkTuple 7 19 13))))
(= (Associations 14) (Associations 13))))

(and (= (accept_case_Final 13) 1)
(xor (= (Associations 14) 
(union  (Associations 13) (singleton(mkTuple 2 20 13))))
(= (Associations 14) (Associations 13))))

(and (= (approve_case 13) 1)
(xor (= (Associations 14) 
(setminus  (Associations 13) (singleton(mkTuple 2 20 13))))
(= (Associations 14) (Associations 13))))
...
(assert 
(xor 
(= (accept_refuse_case_A 14) 0) 
(and (member (mkTuple 7 19 3) (AccessRights 14)) (= (accept_refuse_case_A 14) 1))
)
)				
(assert 
(xor 
(= (withdraw_case_info 14) 0) 
(and (member (mkTuple 10 15 3) (AccessRights 14)) (= (withdraw_case_info 14) 1))
)
)				
(assert 
(xor 
(= (accept_case_Final 14) 0) 
(and (member (mkTuple 7 19 3) (AccessRights 14)) (= (accept_case_Final 14) 1))
)
)				
(assert 
(xor 
(= (approve_case 14) 0) 
(and (member (mkTuple 2 20 3) (AccessRights 14)) (= (approve_case 14) 1))
)
)				
...
(assert (or 
(and (= (accept_refuse_case_A 14) 1)
(xor (= (Associations 15) 
(setminus (union  (Associations 14) (singleton(mkTuple 6 19 3))) (singleton(mkTuple 7 20 13))))
(= (Associations 15) (Associations 14))))

(and (= (withdraw_case_info 14) 1)
(xor (= (Associations 15) 
(union  (Associations 14) (singleton(mkTuple 7 19 13))))
(= (Associations 15) (Associations 14))))

(and (= (accept_case_Final 14) 1)
(xor (= (Associations 15) 
(union  (Associations 14) (singleton(mkTuple 2 20 13))))
(= (Associations 15) (Associations 14))))

(and (= (approve_case 14) 1)
(xor (= (Associations 15) 
(setminus  (Associations 14) (singleton(mkTuple 2 20 13))))
(= (Associations 15) (Associations 14))))
