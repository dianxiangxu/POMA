...
(and (= (obligation1 0) 1)
(xor (= GRAPH1 
(setminus (union  OldGRAPH1 (singleton(mkTuple 4 8))) (singleton(mkTuple 2 8)))
(= GRAPH1 OldGRAPH1)))
...
(and (= (obligation1 1) 1)
(xor (= GRAPH2 
(setminus (union  OldGRAPH2 (singleton(mkTuple 4 8))) (singleton(mkTuple 2 8)))
(= GRAPH2 OldGRAPH2)))
...
(and (= (obligation1 2) 1)
(xor (= GRAPH3 
(setminus (union  OldGRAPH3 (singleton(mkTuple 4 8))) (singleton(mkTuple 2 8)))
(= GRAPH3 OldGRAPH3)))
...
(and (= (obligation1 3) 1)
(xor (= GRAPH4 
(setminus (union  OldGRAPH4 (singleton(mkTuple 4 8))) (singleton(mkTuple 2 8)))
(= GRAPH4 OldGRAPH4)))
...
(and (= (obligation1 4) 1)
(xor (= GRAPH5 
(setminus (union  OldGRAPH5 (singleton(mkTuple 4 8))) (singleton(mkTuple 2 8)))
(= GRAPH5 OldGRAPH5)))
