...
(assert (= GRAPH0 (insert (mkTuple 8 2) 
(mkTuple 7 11) 
(mkTuple 12 6) 
(mkTuple 10 5) 
(mkTuple 1 13) 
...
(and (member (mkTuple 6 15 3) (AccessRights 0)) (= (withdraw_case_info 0) 1))
)
)				
(assert 
(xor 
(= (accept_refuse_case_A 0) 0) 
(and (member (mkTuple 5 19 3) (AccessRights 0)) (= (accept_refuse_case_A 0) 1))
)
)				
(assert 
(xor 
(= (accept_case_Final 0) 0) 
(and (member (mkTuple 5 19 3) (AccessRights 0)) (= (accept_case_Final 0) 1))
)
)				
(assert 
(xor 
...
(xor (= (Associations 1) 
(union  (Associations 0) (singleton(mkTuple 5 19 13))))
(= (Associations 1) (Associations 0))))

(and (= (accept_refuse_case_A 0) 1)
(xor (= (Associations 1) 
(setminus (union  (Associations 0) (singleton(mkTuple 6 19 3))) (singleton(mkTuple 5 20 13))))
(= (Associations 1) (Associations 0))))
...
(and (member (mkTuple 6 15 3) (AccessRights 1)) (= (withdraw_case_info 1) 1))
)
)				
(assert 
(xor 
(= (accept_refuse_case_A 1) 0) 
(and (member (mkTuple 5 19 3) (AccessRights 1)) (= (accept_refuse_case_A 1) 1))
)
)				
(assert 
(xor 
(= (accept_case_Final 1) 0) 
(and (member (mkTuple 5 19 3) (AccessRights 1)) (= (accept_case_Final 1) 1))
)
)				
(assert 
(xor 
...
(xor (= (Associations 2) 
(union  (Associations 1) (singleton(mkTuple 5 19 13))))
(= (Associations 2) (Associations 1))))

(and (= (accept_refuse_case_A 1) 1)
(xor (= (Associations 2) 
(setminus (union  (Associations 1) (singleton(mkTuple 6 19 3))) (singleton(mkTuple 5 20 13))))
(= (Associations 2) (Associations 1))))
...
(and (member (mkTuple 6 15 3) (AccessRights 2)) (= (withdraw_case_info 2) 1))
)
)				
(assert 
(xor 
(= (accept_refuse_case_A 2) 0) 
(and (member (mkTuple 5 19 3) (AccessRights 2)) (= (accept_refuse_case_A 2) 1))
)
)				
(assert 
(xor 
(= (accept_case_Final 2) 0) 
(and (member (mkTuple 5 19 3) (AccessRights 2)) (= (accept_case_Final 2) 1))
)
)				
(assert 
(xor 
...
(xor (= (Associations 3) 
(union  (Associations 2) (singleton(mkTuple 5 19 13))))
(= (Associations 3) (Associations 2))))

(and (= (accept_refuse_case_A 2) 1)
(xor (= (Associations 3) 
(setminus (union  (Associations 2) (singleton(mkTuple 6 19 3))) (singleton(mkTuple 5 20 13))))
(= (Associations 3) (Associations 2))))
...
(and (member (mkTuple 6 15 3) (AccessRights 3)) (= (withdraw_case_info 3) 1))
)
)				
(assert 
(xor 
(= (accept_refuse_case_A 3) 0) 
(and (member (mkTuple 5 19 3) (AccessRights 3)) (= (accept_refuse_case_A 3) 1))
)
)				
(assert 
(xor 
(= (accept_case_Final 3) 0) 
(and (member (mkTuple 5 19 3) (AccessRights 3)) (= (accept_case_Final 3) 1))
)
)				
(assert 
(xor 
...
(xor (= (Associations 4) 
(union  (Associations 3) (singleton(mkTuple 5 19 13))))
(= (Associations 4) (Associations 3))))

(and (= (accept_refuse_case_A 3) 1)
(xor (= (Associations 4) 
(setminus (union  (Associations 3) (singleton(mkTuple 6 19 3))) (singleton(mkTuple 5 20 13))))
(= (Associations 4) (Associations 3))))
...
(and (member (mkTuple 6 15 3) (AccessRights 4)) (= (withdraw_case_info 4) 1))
)
)				
(assert 
(xor 
(= (accept_refuse_case_A 4) 0) 
(and (member (mkTuple 5 19 3) (AccessRights 4)) (= (accept_refuse_case_A 4) 1))
)
)				
(assert 
(xor 
(= (accept_case_Final 4) 0) 
(and (member (mkTuple 5 19 3) (AccessRights 4)) (= (accept_case_Final 4) 1))
)
)				
(assert 
(xor 
...
(xor (= (Associations 5) 
(union  (Associations 4) (singleton(mkTuple 5 19 13))))
(= (Associations 5) (Associations 4))))

(and (= (accept_refuse_case_A 4) 1)
(xor (= (Associations 5) 
(setminus (union  (Associations 4) (singleton(mkTuple 6 19 3))) (singleton(mkTuple 5 20 13))))
(= (Associations 5) (Associations 4))))
...
;PROPERTY
(assert (= (accept_refuse_case_A 4) 1))
