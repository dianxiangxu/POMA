...
(assert (= GRAPH0 (insert (mkTuple 13 3) 
(mkTuple 9 16) 
(mkTuple 4 16) 
(mkTuple 18 16) 
(mkTuple 2 16) 
...
(and (= (obligation4 0) 1)
(xor (= (Associations 1) 
(setminus (union  (Associations 0) (singleton(mkTuple 10 32 15))) (singleton(mkTuple 9 32 15))))
(= (Associations 1) (Associations 0))))

(and (= (obligation5 0) 1)
(xor (= (Associations 1) 
(setminus (union  (Associations 0) (singleton(mkTuple 12 33 15))) (singleton(mkTuple 10 33 15))))
(= (Associations 1) (Associations 0))))

(and (= (obligation6 0) 1)
(xor (= (Associations 1) 
(setminus (union  (Associations 0) (singleton(mkTuple 17 31 15))) (singleton(mkTuple 12 31 15))))
(= (Associations 1) (Associations 0))))
...
(and (= (obligation9 0) 1)
(xor (= (Associations 1) 
(setminus (union  (Associations 0) (singleton(mkTuple 4 32 15))) (singleton(mkTuple 8 32 15))))
(= (Associations 1) (Associations 0))))

(and (= (obligation10 0) 1)
(xor (= (Associations 1) 
(setminus (union  (Associations 0) (singleton(mkTuple 5 33 15))) (singleton(mkTuple 4 33 15))))
(= (Associations 1) (Associations 0))))

(and (= (obligation11 0) 1)
(xor (= (Associations 1) 
(setminus (union  (Associations 0) (singleton(mkTuple 5 34 15))) (singleton(mkTuple 5 34 15))))
(= (Associations 1) (Associations 0))))

(and (= (obligation12 0) 1)
(xor (= (Associations 1) 
(setminus (union  (Associations 0) (singleton(mkTuple 4 36 15))) (singleton(mkTuple 5 36 15))))
(= (Associations 1) (Associations 0))))
...
(and (= (obligation4 1) 1)
(xor (= (Associations 2) 
(setminus (union  (Associations 1) (singleton(mkTuple 10 32 15))) (singleton(mkTuple 9 32 15))))
(= (Associations 2) (Associations 1))))

(and (= (obligation5 1) 1)
(xor (= (Associations 2) 
(setminus (union  (Associations 1) (singleton(mkTuple 12 33 15))) (singleton(mkTuple 10 33 15))))
(= (Associations 2) (Associations 1))))

(and (= (obligation6 1) 1)
(xor (= (Associations 2) 
(setminus (union  (Associations 1) (singleton(mkTuple 17 31 15))) (singleton(mkTuple 12 31 15))))
(= (Associations 2) (Associations 1))))
...
(and (= (obligation9 1) 1)
(xor (= (Associations 2) 
(setminus (union  (Associations 1) (singleton(mkTuple 4 32 15))) (singleton(mkTuple 8 32 15))))
(= (Associations 2) (Associations 1))))

(and (= (obligation10 1) 1)
(xor (= (Associations 2) 
(setminus (union  (Associations 1) (singleton(mkTuple 5 33 15))) (singleton(mkTuple 4 33 15))))
(= (Associations 2) (Associations 1))))

(and (= (obligation11 1) 1)
(xor (= (Associations 2) 
(setminus (union  (Associations 1) (singleton(mkTuple 5 34 15))) (singleton(mkTuple 5 34 15))))
(= (Associations 2) (Associations 1))))

(and (= (obligation12 1) 1)
(xor (= (Associations 2) 
(setminus (union  (Associations 1) (singleton(mkTuple 4 36 15))) (singleton(mkTuple 5 36 15))))
(= (Associations 2) (Associations 1))))
...
(and (= (obligation4 2) 1)
(xor (= (Associations 3) 
(setminus (union  (Associations 2) (singleton(mkTuple 10 32 15))) (singleton(mkTuple 9 32 15))))
(= (Associations 3) (Associations 2))))

(and (= (obligation5 2) 1)
(xor (= (Associations 3) 
(setminus (union  (Associations 2) (singleton(mkTuple 12 33 15))) (singleton(mkTuple 10 33 15))))
(= (Associations 3) (Associations 2))))

(and (= (obligation6 2) 1)
(xor (= (Associations 3) 
(setminus (union  (Associations 2) (singleton(mkTuple 17 31 15))) (singleton(mkTuple 12 31 15))))
(= (Associations 3) (Associations 2))))
...
(and (= (obligation9 2) 1)
(xor (= (Associations 3) 
(setminus (union  (Associations 2) (singleton(mkTuple 4 32 15))) (singleton(mkTuple 8 32 15))))
(= (Associations 3) (Associations 2))))

(and (= (obligation10 2) 1)
(xor (= (Associations 3) 
(setminus (union  (Associations 2) (singleton(mkTuple 5 33 15))) (singleton(mkTuple 4 33 15))))
(= (Associations 3) (Associations 2))))

(and (= (obligation11 2) 1)
(xor (= (Associations 3) 
(setminus (union  (Associations 2) (singleton(mkTuple 5 34 15))) (singleton(mkTuple 5 34 15))))
(= (Associations 3) (Associations 2))))

(and (= (obligation12 2) 1)
(xor (= (Associations 3) 
(setminus (union  (Associations 2) (singleton(mkTuple 4 36 15))) (singleton(mkTuple 5 36 15))))
(= (Associations 3) (Associations 2))))
...
(and (= (obligation4 3) 1)
(xor (= (Associations 4) 
(setminus (union  (Associations 3) (singleton(mkTuple 10 32 15))) (singleton(mkTuple 9 32 15))))
(= (Associations 4) (Associations 3))))

(and (= (obligation5 3) 1)
(xor (= (Associations 4) 
(setminus (union  (Associations 3) (singleton(mkTuple 12 33 15))) (singleton(mkTuple 10 33 15))))
(= (Associations 4) (Associations 3))))

(and (= (obligation6 3) 1)
(xor (= (Associations 4) 
(setminus (union  (Associations 3) (singleton(mkTuple 17 31 15))) (singleton(mkTuple 12 31 15))))
(= (Associations 4) (Associations 3))))
...
(and (= (obligation9 3) 1)
(xor (= (Associations 4) 
(setminus (union  (Associations 3) (singleton(mkTuple 4 32 15))) (singleton(mkTuple 8 32 15))))
(= (Associations 4) (Associations 3))))

(and (= (obligation10 3) 1)
(xor (= (Associations 4) 
(setminus (union  (Associations 3) (singleton(mkTuple 5 33 15))) (singleton(mkTuple 4 33 15))))
(= (Associations 4) (Associations 3))))

(and (= (obligation11 3) 1)
(xor (= (Associations 4) 
(setminus (union  (Associations 3) (singleton(mkTuple 5 34 15))) (singleton(mkTuple 5 34 15))))
(= (Associations 4) (Associations 3))))

(and (= (obligation12 3) 1)
(xor (= (Associations 4) 
(setminus (union  (Associations 3) (singleton(mkTuple 4 36 15))) (singleton(mkTuple 5 36 15))))
(= (Associations 4) (Associations 3))))
...
(and (= (obligation4 4) 1)
(xor (= (Associations 5) 
(setminus (union  (Associations 4) (singleton(mkTuple 10 32 15))) (singleton(mkTuple 9 32 15))))
(= (Associations 5) (Associations 4))))

(and (= (obligation5 4) 1)
(xor (= (Associations 5) 
(setminus (union  (Associations 4) (singleton(mkTuple 12 33 15))) (singleton(mkTuple 10 33 15))))
(= (Associations 5) (Associations 4))))

(and (= (obligation6 4) 1)
(xor (= (Associations 5) 
(setminus (union  (Associations 4) (singleton(mkTuple 17 31 15))) (singleton(mkTuple 12 31 15))))
(= (Associations 5) (Associations 4))))
...
(and (= (obligation9 4) 1)
(xor (= (Associations 5) 
(setminus (union  (Associations 4) (singleton(mkTuple 4 32 15))) (singleton(mkTuple 8 32 15))))
(= (Associations 5) (Associations 4))))

(and (= (obligation10 4) 1)
(xor (= (Associations 5) 
(setminus (union  (Associations 4) (singleton(mkTuple 5 33 15))) (singleton(mkTuple 4 33 15))))
(= (Associations 5) (Associations 4))))

(and (= (obligation11 4) 1)
(xor (= (Associations 5) 
(setminus (union  (Associations 4) (singleton(mkTuple 5 34 15))) (singleton(mkTuple 5 34 15))))
(= (Associations 5) (Associations 4))))

(and (= (obligation12 4) 1)
(xor (= (Associations 5) 
(setminus (union  (Associations 4) (singleton(mkTuple 4 36 15))) (singleton(mkTuple 5 36 15))))
(= (Associations 5) (Associations 4))))
