...
(xor 
(= (obligation1 5) 0) 
(and (member (mkTuple 28 43 29) (AccessRights 5)) (= (obligation1 5) 1))
)
)				
(assert 
(xor 
(= (obligation2 5) 0) 
(and (member (mkTuple 6 42 29) (AccessRights 5)) (= (obligation2 5) 1))
)
)				
(assert 
(xor 
(= (obligation3 5) 0) 
(and (member (mkTuple 12 42 29) (AccessRights 5)) (= (obligation3 5) 1))
)
)				
(assert 
(xor 
(= (obligation4 5) 0) 
(and (member (mkTuple 21 42 29) (AccessRights 5)) (= (obligation4 5) 1))
)
)				
(assert 
(xor 
(= (obligation5 5) 0) 
(and (member (mkTuple 22 43 29) (AccessRights 5)) (= (obligation5 5) 1))
)
)				
(assert 
(xor 
(= (obligation6 5) 0) 
(and (member (mkTuple 23 44 29) (AccessRights 5)) (= (obligation6 5) 1))
)
)				
(assert 
(xor 
(= (obligation7 5) 0) 
(and (member (mkTuple 15 42 29) (AccessRights 5)) (= (obligation7 5) 1))
)
)				
(assert 
(xor 
(= (obligation8 5) 0) 
(and (member (mkTuple 17 42 29) (AccessRights 5)) (= (obligation8 5) 1))
)
)				
(assert 
(xor 
(= (obligation9 5) 0) 
(and (member (mkTuple 20 42 29) (AccessRights 5)) (= (obligation9 5) 1))
)
)				
(assert 
(xor 
(= (obligation10 5) 0) 
(and (member (mkTuple 7 43 29) (AccessRights 5)) (= (obligation10 5) 1))
)
)				
(assert 
(xor 
(= (obligation11 5) 0) 
(and (member (mkTuple 9 44 29) (AccessRights 5)) (= (obligation11 5) 1))
)
)				
(assert 
(xor 
(= (obligation12 5) 0) 
(and (member (mkTuple 9 45 29) (AccessRights 5)) (= (obligation12 5) 1))
)
)				
(assert 
(xor 
(= (obligation13 5) 0) 
(and (member (mkTuple 7 47 29) (AccessRights 5)) (= (obligation13 5) 1))
)
)				
...
(and (= (obligation1 5) 1)
(xor (= (Associations 6) 
(setminus (union  (Associations 5) (singleton(mkTuple 6 42 29))) (singleton(mkTuple 28 42 29))))
(= (Associations 6) (Associations 5))))

(and (= (obligation2 5) 1)
(xor (= (Associations 6) 
(setminus (union  (Associations 5) (singleton(mkTuple 12 42 29))) (singleton(mkTuple 6 42 29))))
(= (Associations 6) (Associations 5))))

(and (= (obligation3 5) 1)
(xor (= (Associations 6) 
(setminus (union  (Associations 5) (singleton(mkTuple 21 42 29))) (singleton(mkTuple 12 42 29))))
(= (Associations 6) (Associations 5))))

(and (= (obligation4 5) 1)
(xor (= (Associations 6) 
(setminus (union  (Associations 5) (singleton(mkTuple 22 43 29))) (singleton(mkTuple 21 42 29))))
(= (Associations 6) (Associations 5))))

(and (= (obligation5 5) 1)
(xor (= (Associations 6) 
(setminus (union  (Associations 5) (singleton(mkTuple 23 44 29))) (singleton(mkTuple 22 43 29))))
(= (Associations 6) (Associations 5))))

(and (= (obligation6 5) 1)
(xor (= (Associations 6) 
(setminus (union  (Associations 5) (singleton(mkTuple 15 42 29))) (singleton(mkTuple 23 44 29))))
(= (Associations 6) (Associations 5))))

(and (= (obligation7 5) 1)
(xor (= (Associations 6) 
(setminus (union  (Associations 5) (singleton(mkTuple 17 42 29))) (singleton(mkTuple 15 42 29))))
(= (Associations 6) (Associations 5))))

(and (= (obligation8 5) 1)
(xor (= (Associations 6) 
(setminus (union  (Associations 5) (singleton(mkTuple 20 42 29))) (singleton(mkTuple 17 42 29))))
(= (Associations 6) (Associations 5))))

(and (= (obligation9 5) 1)
(xor (= (Associations 6) 
(setminus (union  (Associations 5) (singleton(mkTuple 7 43 29))) (singleton(mkTuple 20 42 29))))
(= (Associations 6) (Associations 5))))

(and (= (obligation10 5) 1)
(xor (= (Associations 6) 
(setminus (union  (Associations 5) (singleton(mkTuple 9 44 29))) (singleton(mkTuple 7 42 29))))
(= (Associations 6) (Associations 5))))

(and (= (obligation11 5) 1)
(xor (= (Associations 6) 
(setminus (union  (Associations 5) (singleton(mkTuple 9 45 29))) (singleton(mkTuple 9 44 29))))
(= (Associations 6) (Associations 5))))

(and (= (obligation12 5) 1)
(xor (= (Associations 6) 
(setminus (union  (Associations 5) (singleton(mkTuple 7 47 29))) (singleton(mkTuple 9 45 29))))
(= (Associations 6) (Associations 5))))

(and (= (obligation13 5) 1)
(xor (= (Associations 6) 
(setminus (union  (Associations 5) (singleton(mkTuple 9 47 29))) (singleton(mkTuple 7 47 29))))
(= (Associations 6) (Associations 5))))
...
(xor 
(= (obligation1 6) 0) 
(and (member (mkTuple 28 43 29) (AccessRights 6)) (= (obligation1 6) 1))
)
)				
(assert 
(xor 
(= (obligation2 6) 0) 
(and (member (mkTuple 6 42 29) (AccessRights 6)) (= (obligation2 6) 1))
)
)				
(assert 
(xor 
(= (obligation3 6) 0) 
(and (member (mkTuple 12 42 29) (AccessRights 6)) (= (obligation3 6) 1))
)
)				
(assert 
(xor 
(= (obligation4 6) 0) 
(and (member (mkTuple 21 42 29) (AccessRights 6)) (= (obligation4 6) 1))
)
)				
(assert 
(xor 
(= (obligation5 6) 0) 
(and (member (mkTuple 22 43 29) (AccessRights 6)) (= (obligation5 6) 1))
)
)				
(assert 
(xor 
(= (obligation6 6) 0) 
(and (member (mkTuple 23 44 29) (AccessRights 6)) (= (obligation6 6) 1))
)
)				
(assert 
(xor 
(= (obligation7 6) 0) 
(and (member (mkTuple 15 42 29) (AccessRights 6)) (= (obligation7 6) 1))
)
)				
(assert 
(xor 
(= (obligation8 6) 0) 
(and (member (mkTuple 17 42 29) (AccessRights 6)) (= (obligation8 6) 1))
)
)				
(assert 
(xor 
(= (obligation9 6) 0) 
(and (member (mkTuple 20 42 29) (AccessRights 6)) (= (obligation9 6) 1))
)
)				
(assert 
(xor 
(= (obligation10 6) 0) 
(and (member (mkTuple 7 43 29) (AccessRights 6)) (= (obligation10 6) 1))
)
)				
(assert 
(xor 
(= (obligation11 6) 0) 
(and (member (mkTuple 9 44 29) (AccessRights 6)) (= (obligation11 6) 1))
)
)				
(assert 
(xor 
(= (obligation12 6) 0) 
(and (member (mkTuple 9 45 29) (AccessRights 6)) (= (obligation12 6) 1))
)
)				
(assert 
(xor 
(= (obligation13 6) 0) 
(and (member (mkTuple 7 47 29) (AccessRights 6)) (= (obligation13 6) 1))
)
)				
...
(and (= (obligation1 6) 1)
(xor (= (Associations 7) 
(setminus (union  (Associations 6) (singleton(mkTuple 6 42 29))) (singleton(mkTuple 28 42 29))))
(= (Associations 7) (Associations 6))))

(and (= (obligation2 6) 1)
(xor (= (Associations 7) 
(setminus (union  (Associations 6) (singleton(mkTuple 12 42 29))) (singleton(mkTuple 6 42 29))))
(= (Associations 7) (Associations 6))))

(and (= (obligation3 6) 1)
(xor (= (Associations 7) 
(setminus (union  (Associations 6) (singleton(mkTuple 21 42 29))) (singleton(mkTuple 12 42 29))))
(= (Associations 7) (Associations 6))))

(and (= (obligation4 6) 1)
(xor (= (Associations 7) 
(setminus (union  (Associations 6) (singleton(mkTuple 22 43 29))) (singleton(mkTuple 21 42 29))))
(= (Associations 7) (Associations 6))))

(and (= (obligation5 6) 1)
(xor (= (Associations 7) 
(setminus (union  (Associations 6) (singleton(mkTuple 23 44 29))) (singleton(mkTuple 22 43 29))))
(= (Associations 7) (Associations 6))))

(and (= (obligation6 6) 1)
(xor (= (Associations 7) 
(setminus (union  (Associations 6) (singleton(mkTuple 15 42 29))) (singleton(mkTuple 23 44 29))))
(= (Associations 7) (Associations 6))))

(and (= (obligation7 6) 1)
(xor (= (Associations 7) 
(setminus (union  (Associations 6) (singleton(mkTuple 17 42 29))) (singleton(mkTuple 15 42 29))))
(= (Associations 7) (Associations 6))))

(and (= (obligation8 6) 1)
(xor (= (Associations 7) 
(setminus (union  (Associations 6) (singleton(mkTuple 20 42 29))) (singleton(mkTuple 17 42 29))))
(= (Associations 7) (Associations 6))))

(and (= (obligation9 6) 1)
(xor (= (Associations 7) 
(setminus (union  (Associations 6) (singleton(mkTuple 7 43 29))) (singleton(mkTuple 20 42 29))))
(= (Associations 7) (Associations 6))))

(and (= (obligation10 6) 1)
(xor (= (Associations 7) 
(setminus (union  (Associations 6) (singleton(mkTuple 9 44 29))) (singleton(mkTuple 7 42 29))))
(= (Associations 7) (Associations 6))))

(and (= (obligation11 6) 1)
(xor (= (Associations 7) 
(setminus (union  (Associations 6) (singleton(mkTuple 9 45 29))) (singleton(mkTuple 9 44 29))))
(= (Associations 7) (Associations 6))))

(and (= (obligation12 6) 1)
(xor (= (Associations 7) 
(setminus (union  (Associations 6) (singleton(mkTuple 7 47 29))) (singleton(mkTuple 9 45 29))))
(= (Associations 7) (Associations 6))))

(and (= (obligation13 6) 1)
(xor (= (Associations 7) 
(setminus (union  (Associations 6) (singleton(mkTuple 9 47 29))) (singleton(mkTuple 7 47 29))))
(= (Associations 7) (Associations 6))))
