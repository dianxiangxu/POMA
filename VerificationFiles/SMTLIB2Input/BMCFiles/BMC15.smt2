...
(assert (member (mkTuple "UA1_1" "test1" "Container1") (FinalJoin 15)))
...
(assert (= (Tclosure 14) (tclosure (Containment 14))))
(assert (or(and (= (Containment 14) (union(singleton(mkTuple "UA2_2" "UA_test1"))
(Containment 13))) (= (Associations 14) (Associations 13)))(and (= (Containment 14) (union(singleton(mkTuple "UA1_1" "UA_test1"))
(Containment 13))) (= (Associations 14) (Associations 13)))))
...
(assert (= (FinalJoinOnlyAR 14) (join (transpose (join (FinalJoin 14)  SetToCheckATOnlyAR)) SetToCheckUAOnlyAR)))
(assert (= (Tclosure 15) (tclosure (Containment 15))))
(assert (or(and (= (Containment 15) (union(singleton(mkTuple "UA2_2" "UA_test1"))
(Containment 14))) (= (Associations 15) (Associations 14)))(and (= (Containment 15) (union(singleton(mkTuple "UA1_1" "UA_test1"))
(Containment 14))) (= (Associations 15) (Associations 14)))))
...
(assert (= (FinalJoinOnlyAR 15) (join (transpose (join (FinalJoin 15)  SetToCheckATOnlyAR)) SetToCheckUAOnlyAR)))
