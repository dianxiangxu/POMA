...
(assert ( or
(and (= (obligation3 1) 1) (xor (= (Associations 2) (setminus (union (singleton(mkTuple 5 20 11)) (Associations 1))(singleton(mkTuple 3 20 11)))) (= (Associations 2) (Associations 1))))
(and (= (obligation2 1) 1) (xor (= (Associations 2) (setminus (union (singleton(mkTuple 3 20 11)) (Associations 1))(singleton(mkTuple 2 20 11)))) (= (Associations 2) (Associations 1))))
(and (= (obligation4 1) 1) (xor (= (Associations 2) (setminus (union (singleton(mkTuple 6 22 11)) (Associations 1))(singleton(mkTuple 5 20 11)))) (= (Associations 2) (Associations 1))))
(and (= (obligation1 1) 1) (xor (= (Associations 2) (setminus (union (singleton(mkTuple 2 20 11)) (Associations 1))(singleton(mkTuple 10 20 11)))) (= (Associations 2) (Associations 1))))(= (Associations 2) (Associations 1))))
...
(xor 
(= (obligation1 2) 0) 
(and (member (mkTuple 10 22 11) (AccessRights 2)) (= (obligation1 2) 1))
)
)				
(assert 
(xor 
(= (obligation2 2) 0) 
(and (member (mkTuple 2 20 11) (AccessRights 2)) (= (obligation2 2) 1))
)
)				
(assert 
(xor 
(= (obligation3 2) 0) 
(and (member (mkTuple 3 20 11) (AccessRights 2)) (= (obligation3 2) 1))
)
)				
(assert 
(xor 
(= (obligation4 2) 0) 
(and (member (mkTuple 5 20 11) (AccessRights 2)) (= (obligation4 2) 1))
)
)				
...
(assert ( or
(and (= (obligation3 2) 1) (xor (= (Associations 3) (setminus (union (singleton(mkTuple 5 20 11)) (Associations 2))(singleton(mkTuple 3 20 11)))) (= (Associations 3) (Associations 2))))
(and (= (obligation2 2) 1) (xor (= (Associations 3) (setminus (union (singleton(mkTuple 3 20 11)) (Associations 2))(singleton(mkTuple 2 20 11)))) (= (Associations 3) (Associations 2))))
(and (= (obligation4 2) 1) (xor (= (Associations 3) (setminus (union (singleton(mkTuple 6 22 11)) (Associations 2))(singleton(mkTuple 5 20 11)))) (= (Associations 3) (Associations 2))))
(and (= (obligation1 2) 1) (xor (= (Associations 3) (setminus (union (singleton(mkTuple 2 20 11)) (Associations 2))(singleton(mkTuple 10 20 11)))) (= (Associations 3) (Associations 2))))(= (Associations 3) (Associations 2))))
...
(xor 
(= (obligation1 3) 0) 
(and (member (mkTuple 10 22 11) (AccessRights 3)) (= (obligation1 3) 1))
)
)				
(assert 
(xor 
(= (obligation2 3) 0) 
(and (member (mkTuple 2 20 11) (AccessRights 3)) (= (obligation2 3) 1))
)
)				
(assert 
(xor 
(= (obligation3 3) 0) 
(and (member (mkTuple 3 20 11) (AccessRights 3)) (= (obligation3 3) 1))
)
)				
(assert 
(xor 
(= (obligation4 3) 0) 
(and (member (mkTuple 5 20 11) (AccessRights 3)) (= (obligation4 3) 1))
)
)				
...
(assert ( or
(and (= (obligation3 3) 1) (xor (= (Associations 4) (setminus (union (singleton(mkTuple 5 20 11)) (Associations 3))(singleton(mkTuple 3 20 11)))) (= (Associations 4) (Associations 3))))
(and (= (obligation2 3) 1) (xor (= (Associations 4) (setminus (union (singleton(mkTuple 3 20 11)) (Associations 3))(singleton(mkTuple 2 20 11)))) (= (Associations 4) (Associations 3))))
(and (= (obligation4 3) 1) (xor (= (Associations 4) (setminus (union (singleton(mkTuple 6 22 11)) (Associations 3))(singleton(mkTuple 5 20 11)))) (= (Associations 4) (Associations 3))))
(and (= (obligation1 3) 1) (xor (= (Associations 4) (setminus (union (singleton(mkTuple 2 20 11)) (Associations 3))(singleton(mkTuple 10 20 11)))) (= (Associations 4) (Associations 3))))(= (Associations 4) (Associations 3))))
