...
(assert ( or
(and (= (obligation3 2) 1) (xor (= (Associations 3) (union (singleton(mkTuple 5 20 11)) (Associations 2))) (= (Associations 3) (Associations 2))))
(and (= (obligation2 2) 1) (xor (= (Associations 3) (union (singleton(mkTuple 3 20 11)) (Associations 2))) (= (Associations 3) (Associations 2))))
(and (= (obligation4 2) 1) (xor (= (Associations 3) (union (singleton(mkTuple 6 22 11)) (Associations 2))) (= (Associations 3) (Associations 2))))
(and (= (obligation1 2) 1) (xor (= (Associations 3) (union (singleton(mkTuple 2 20 11)) (Associations 2))) (= (Associations 3) (Associations 2))))(= (Associations 3) (Associations 2))))
...
(assert ( or
(and (= (obligation3 3) 1) (xor (= (Associations 4) (union (singleton(mkTuple 5 20 11)) (Associations 3))) (= (Associations 4) (Associations 3))))
(and (= (obligation2 3) 1) (xor (= (Associations 4) (union (singleton(mkTuple 3 20 11)) (Associations 3))) (= (Associations 4) (Associations 3))))
(and (= (obligation4 3) 1) (xor (= (Associations 4) (union (singleton(mkTuple 6 22 11)) (Associations 3))) (= (Associations 4) (Associations 3))))
(and (= (obligation1 3) 1) (xor (= (Associations 4) (union (singleton(mkTuple 2 20 11)) (Associations 3))) (= (Associations 4) (Associations 3))))(= (Associations 4) (Associations 3))))
