...
(xor 
(= (obligation1 6) 0) 
(and (member (mkTuple 33 51 34) (AccessRights 6)) (= (obligation1 6) 1))
)
)				
(assert 
(xor 
(= (obligation2 6) 0) 
(and (member (mkTuple 6 50 34) (AccessRights 6)) (= (obligation2 6) 1))
)
)				
(assert 
(xor 
(= (obligation3 6) 0) 
(and (member (mkTuple 12 50 34) (AccessRights 6)) (= (obligation3 6) 1))
)
)				
(assert 
(xor 
(= (obligation4 6) 0) 
(and (member (mkTuple 22 50 34) (AccessRights 6)) (= (obligation4 6) 1))
)
)				
(assert 
(xor 
(= (obligation5 6) 0) 
(and (member (mkTuple 23 51 34) (AccessRights 6)) (= (obligation5 6) 1))
)
)				
(assert 
(xor 
(= (obligation6 6) 0) 
(and (member (mkTuple 26 52 34) (AccessRights 6)) (= (obligation6 6) 1))
)
)				
(assert 
(xor 
(= (obligation7 6) 0) 
(and (member (mkTuple 16 50 34) (AccessRights 6)) (= (obligation7 6) 1))
)
)				
(assert 
(xor 
(= (obligation8 6) 0) 
(and (member (mkTuple 18 50 34) (AccessRights 6)) (= (obligation8 6) 1))
)
)				
(assert 
(xor 
(= (obligation9 6) 0) 
(and (member (mkTuple 21 50 34) (AccessRights 6)) (= (obligation9 6) 1))
)
)				
(assert 
(xor 
(= (obligation10 6) 0) 
(and (member (mkTuple 7 51 34) (AccessRights 6)) (= (obligation10 6) 1))
)
)				
(assert 
(xor 
(= (obligation11 6) 0) 
(and (member (mkTuple 9 52 34) (AccessRights 6)) (= (obligation11 6) 1))
)
)				
(assert 
(xor 
(= (obligation12 6) 0) 
(and (member (mkTuple 9 53 34) (AccessRights 6)) (= (obligation12 6) 1))
)
)				
(assert 
(xor 
(= (obligation13 6) 0) 
(and (member (mkTuple 7 55 34) (AccessRights 6)) (= (obligation13 6) 1))
)
)				
...
(and (= (obligation1 6) 1)
(xor (= (Associations 7) 
(setminus (union  (Associations 6) (singleton(mkTuple 6 50 34))) (singleton(mkTuple 33 50 34))))
(= (Associations 7) (Associations 6))))

(and (= (obligation2 6) 1)
(xor (= (Associations 7) 
(setminus (union  (Associations 6) (singleton(mkTuple 12 50 34))) (singleton(mkTuple 6 50 34))))
(= (Associations 7) (Associations 6))))

(and (= (obligation3 6) 1)
(xor (= (Associations 7) 
(setminus (union  (Associations 6) (singleton(mkTuple 22 50 34))) (singleton(mkTuple 12 50 34))))
(= (Associations 7) (Associations 6))))

(and (= (obligation4 6) 1)
(xor (= (Associations 7) 
(setminus (union  (Associations 6) (singleton(mkTuple 23 51 34))) (singleton(mkTuple 22 50 34))))
(= (Associations 7) (Associations 6))))

(and (= (obligation5 6) 1)
(xor (= (Associations 7) 
(setminus (union  (Associations 6) (singleton(mkTuple 26 52 34))) (singleton(mkTuple 23 51 34))))
(= (Associations 7) (Associations 6))))

(and (= (obligation6 6) 1)
(xor (= (Associations 7) 
(setminus (union  (Associations 6) (singleton(mkTuple 16 50 34))) (singleton(mkTuple 26 52 34))))
(= (Associations 7) (Associations 6))))

(and (= (obligation7 6) 1)
(xor (= (Associations 7) 
(setminus (union  (Associations 6) (singleton(mkTuple 18 50 34))) (singleton(mkTuple 16 50 34))))
(= (Associations 7) (Associations 6))))

(and (= (obligation8 6) 1)
(xor (= (Associations 7) 
(setminus (union  (Associations 6) (singleton(mkTuple 21 50 34))) (singleton(mkTuple 18 50 34))))
(= (Associations 7) (Associations 6))))

(and (= (obligation9 6) 1)
(xor (= (Associations 7) 
(setminus (union  (Associations 6) (singleton(mkTuple 7 51 34))) (singleton(mkTuple 21 50 34))))
(= (Associations 7) (Associations 6))))

(and (= (obligation10 6) 1)
(xor (= (Associations 7) 
(setminus (union  (Associations 6) (singleton(mkTuple 9 52 34))) (singleton(mkTuple 7 50 34))))
(= (Associations 7) (Associations 6))))

(and (= (obligation11 6) 1)
(xor (= (Associations 7) 
(setminus (union  (Associations 6) (singleton(mkTuple 9 53 34))) (singleton(mkTuple 9 52 34))))
(= (Associations 7) (Associations 6))))

(and (= (obligation12 6) 1)
(xor (= (Associations 7) 
(setminus (union  (Associations 6) (singleton(mkTuple 7 55 34))) (singleton(mkTuple 9 53 34))))
(= (Associations 7) (Associations 6))))

(and (= (obligation13 6) 1)
(xor (= (Associations 7) 
(setminus (union  (Associations 6) (singleton(mkTuple 9 55 34))) (singleton(mkTuple 7 55 34))))
(= (Associations 7) (Associations 6))))
