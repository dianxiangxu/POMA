...
(declare-fun ASSIGN1_accept_case () (Set (Tuple Int Int)))
...
;t11
;(and
;(not (member (mkTuple 7 10) (ASSIGN 0))); p1
;(= (ASSIGN 1)  (union (ASSIGN 0) (singleton (mkTuple 7 10)))) ; q1
;)

;t12
;(and
;(member (mkTuple 7 10) (ASSIGN 0)); not p1
;)


;t21
;(and
;(member (mkTuple 6 4) (ASSIGN 0)); c2
;(not (member (mkTuple 6 1) (ASSIGN 0))); p2
;(= (ASSIGN 1)  (union (ASSIGN 0) (singleton (mkTuple 6 1)))) ; q2
;)

;t22
;(and
;(member (mkTuple 6 4) (ASSIGN 0)); c2
;(member (mkTuple 6 1) (ASSIGN 0)); not p2
;)

;t23
;(and
;(not(member (mkTuple 6 4) (ASSIGN 0))); not c2
;)
...
(member (mkTuple 6 1) (ASSIGN 0)); p(a1)
(member (mkTuple 6 4) (ASSIGN 0)); p(a2)
(not (member (mkTuple 6 1) (ASSIGN 0))); c2 


(= (ASSIGN 1)  (setminus (setminus (ASSIGN 0) (singleton (mkTuple 6 4)))(singleton (mkTuple 6 1)))) ; q(a1) = delete assign 6 1 ,q(a2) =  assign 6 4
)
...
(and
(member (mkTuple 6 1) (ASSIGN 0)); p(a1)
(= (ASSIGN 1)  (setminus (ASSIGN 0) (singleton (mkTuple 6 1)))) ; q(a1)
)

(and
(not(member (mkTuple 6 1) (ASSIGN 0))); not c2
)
)
...
(and
(and
(not (member (mkTuple 6 1) (ASSIGN 0))); not p(a1)
)

(and
(member (mkTuple 6 1) (ASSIGN 0)); c2
(member (mkTuple 6 4) (ASSIGN 0)); p(a2)
(= (ASSIGN 1)  (setminus (ASSIGN 0) (singleton (mkTuple 6 4)))) ; q(a2)
)
...
(union (union (ASSOC {k-1})(singleton(mkTuple 7 approve 15)))(singleton(mkTuple 7 15)))
