...
//Add one operation
public class MutatorAOO extends ProhibitionMutation {
	public MutatorAOO(String testMethod, Graph graph, Prohibitions prohibitions) throws GraphDoesNotMatchTestSuitException {
