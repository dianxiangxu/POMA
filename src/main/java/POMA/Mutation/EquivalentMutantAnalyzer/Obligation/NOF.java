...
public class NOF extends MutantTester {
	int i;
	static Graph g;
	public NOF(String testMethod, Graph graph, Prohibitions prohibitions, String obligationPath, List<AccessRequest> arList) throws GraphDoesNotMatchTestSuitException {
				...
				if (r.getLabel().equals(ruleLabel)) {
					...
					if (condition != null) {
						...
						for (Function f : functions) {
							...
							if (q == null) {
								System.out.println("Mutant equivalent!(NOF:" + i + ") Negate One Factor:" + rule.getLabel());
							} else {
								Utils.addToARList(q);
