...
class FileTreeModel implements TreeModel {
    ...
    protected void fireTreeStructureChanged(final Object source, final Object[] path, final int[] childIndices, final Object[] children) {
        ...
        for (final TreeModelListener l : mListeners) {
        	...
        	System.out.println(String.valueOf(path[0]));
        	System.out.println(childIndices.length);
        	//System.out.println((MyFile[])children);
...
//                    new TreeModelEvent(
//                       this,
//                       new Object[] { getRoot() }, // Path to the _parent_ of changed item
//                       childIndices,          // Indexes of changed nodes
//                       children  // Objects represents changed nodes
//                                                 //    (Note: old ones!!! 
//                                                 //     I.e. not "C2", but "C",
//                                                 //     in this example)
//                       )
