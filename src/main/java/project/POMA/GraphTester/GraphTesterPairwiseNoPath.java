package project.POMA.GraphTester;
...
public class GraphTesterPairwiseNoPath extends GraphTesterPairwise {
	public GraphTesterPairwiseNoPath() throws Exception {
		super();
	}
	...
	public List<String[]> testGraphPairwisePC() throws PMException {
		...
		int maxGoes = 500;
		long seed = 42;
		ArrayList<int[]> list = AllPairs.generatePairs(choices, seed, maxGoes, !noShuffle, null, false);
		int i = 1;
		for (Node pc : PCs) {
