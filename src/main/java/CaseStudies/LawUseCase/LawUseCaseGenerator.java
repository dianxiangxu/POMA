...
public class LawUseCaseGenerator {
	...
	public static void main(String[] argv) throws PMException, IOException {
		...
		// Prohibition prohibition = new Prohibition.Builder("prohibition1", "UA_test1",
		// new OperationSet("test"))
		...
		Prohibition prohibition2 = new Prohibition.Builder("prohibition2", "Interns",
				new OperationSet("addcase", "deletecase"))
		...
		Prohibition prohibition4 = new Prohibition.Builder("prohibition4", "C-Suit",
				new OperationSet("accept", "disapprove"))
