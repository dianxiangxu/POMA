...
public class MedicalExampleUA {
	public static void main(String[] argv) throws PMException, IOException {
		...
		g.createNode("MaximumCarePatients", UA, null, "ClassificationPolicyClass");
		g.createNode("ModerateCarePatients", UA, null, "ClassificationPolicyClass");
		g.createNode("Patient1", UA, null, "MaximumCarePatients");
		g.createNode("Patient2", UA, null, "ModerateCarePatients");
